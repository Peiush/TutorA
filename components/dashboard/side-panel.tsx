...
import { SearchIcon, ClipboardIcon, ChatDotsIcon, ArrowUpRightIcon } from "@/components/dashboard/dashboard-icons";

const LINKS = [
  { href: "/find-a-tutor", label: "Browse verified tutors", icon: SearchIcon },
  { href: "/request-a-tutor", label: "Submit a new request", icon: ClipboardIcon },
...
export function SidePanel() {
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <h3 className="text-[16px]">Faster matches, better fit</h3>
        <p className="text-[13.5px] mt-2" style={{ color: "color-mix(in srgb, var(--color-text) 72%, transparent)" }}>
          Add your goals and preferred schedule to your next request &mdash; it helps our team match you
          with the right tutor on the first try.
        </p>
      </div>
    </div>
  );
