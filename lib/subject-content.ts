...
export interface SubjectPageContent {
  ...
  /** 3-4 short scannable bullets summarizing subjectDetail, shown above it while the full
   *  prose is collapsed — see components/courses/expandable-detail.tsx. */
  subjectDetailHighlights?: string[];
...
export const subjectPageContent: Record<string, SubjectPageContent> = {
  ...
  // ---------------------------------------------------------------------
  "ap-physics": {
    keywords: ["AP Physics tutoring online", "AP Physics tutor near me", "private AP Physics tutor", "1:1 AP Physics tutoring", "which AP Physics should I take", "AP Physics 1 vs C difference", "AP Physics 1 vs 2 vs C comparison", "AP Physics 1 tutor online", "AP Physics C tutor online", "AP Physics 2 tutor online", "AP Physics course chooser tutor", "AP Physics C Mechanics tutor online", "AP Physics C Electricity and Magnetism tutor", "is AP Physics C harder than Physics 1", "AP Physics 1 or C for engineering", "AP Physics readiness tutor", "AP Physics 1 exam prep tutor", "AP Physics C exam prep tutor", "AP Physics sequence tutor for high school", "Indian tutor for AP Physics", "AP Physics Indian tutor", "AP Physics online Indian tutor", "AP Physics tutor from India", "online AP Physics tutor in India", "hire Indian tutor for AP Physics"],
    template: "chooser",
    chooserIntro:
  ...
  "algebra": {
    keywords: ["Algebra tutoring online", "Algebra tutor near me", "private Algebra tutor", "1:1 Algebra tutoring", "algebra vs pre-algebra which to take", "pre-algebra or algebra 1 for my child", "algebra 1 vs algebra 2 difference", "which algebra class should I take", "algebra placement test prep tutor", "pre-algebra to algebra 1 transition tutor", "algebra readiness test tutor", "algebra 1 tutor online", "algebra 2 tutor online", "pre-algebra tutor online", "algebra course chooser tutor", "algebra 1 or algebra 2 tutor help", "is my child ready for algebra 1", "algebra sequence tutor for middle school", "algebra tutor to choose the right level", "Indian tutor for Algebra", "Algebra Indian tutor", "Algebra online Indian tutor", "Algebra tutor from India", "online Algebra tutor in India", "hire Indian tutor for Algebra"],
    template: "chooser",
    chooserIntro:
  ...
  "ap-physics-1": {
    ...
    subjectDetailHighlights: ["algebra-based exam, no calculus needed", "rewards conceptual reasoning over formula plugging", "free-response demands written justification, not just numbers", "covers kinematics through circuits and SHM in one year"],
    faqs: [
      {
  ...
  "ap-physics-c": {
    ...
    subjectDetailHighlights: ["two separate calculus-based exams, scored independently", "mechanics uses derivatives and integrals, not algebra", "E&M often harder, less overlap with prior courses", "requires real calculus fluency, like integrating variable forces"],
    faqs: [
      {
  ...
  "ap-calculus-ab": {
    keywords: ["AP Calculus AB tutor", "AP Calculus AB tutoring online", "AP Calculus AB tutor near me", "private AP Calculus AB tutor", "1:1 AP Calculus AB tutoring", "AP Calculus AB tutor for a 5", "best AP Calculus AB tutor", "AP Calculus AB tutor reviews", "AP Calculus AB exam tutor", "AP Calculus AB homework help", "live AP Calculus AB tutor", "AP Calculus AB tutor for international students", "AP Calculus AB practice test tutor", "AP Calculus AB FRQ tutor", "AP Calculus AB tutor cost per hour", "online AP Calculus AB tutoring program", "AP Calculus AB crash course tutor", "AP Calculus AB tutor for high schoolers", "certified AP Calculus AB tutor", "Indian tutor for AP Calculus AB", "AP Calculus AB Indian tutor", "AP Calculus AB online Indian tutor", "AP Calculus AB tutor from India", "online AP Calculus AB tutor in India", "hire Indian tutor for AP Calculus AB"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    differentiation:
    ...
    subjectDetailHighlights: ["strict sequence: limits, derivatives, then integrals", "exam splits calculator and non-calculator sections", "free-response rewards written setup, not just answers", "relies on solid precalculus and trig fundamentals"],
    faqs: [
      {
  ...
  "ap-calculus-bc": {
    keywords: ["AP Calculus BC tutor", "AP Calculus BC tutoring online", "AP Calculus BC tutor near me", "private AP Calculus BC tutor", "1:1 AP Calculus BC tutoring", "AP Calculus BC tutor for a 5", "best AP Calculus BC tutor", "AP Calculus BC tutor reviews", "AP Calculus BC exam tutor", "AP Calculus BC homework help", "live AP Calculus BC tutor", "AP Calculus BC tutor for international students", "AP Calculus BC practice test tutor", "AP Calculus BC FRQ tutor", "AP Calculus BC series and sequences tutor", "online AP Calculus BC tutoring program", "AP Calculus BC crash course tutor", "AP Calculus BC tutor for high schoolers", "certified AP Calculus BC tutor", "Indian tutor for AP Calculus BC", "AP Calculus BC Indian tutor", "AP Calculus BC online Indian tutor", "AP Calculus BC tutor from India", "online AP Calculus BC tutor in India", "hire Indian tutor for AP Calculus BC"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    differentiation:
    ...
    subjectDetailHighlights: ["includes all of AB plus series and parametrics", "infinite series convergence tests are the hardest topic", "moves faster, covering more content in same year", "reports a separate AB sub-score alongside BC score"],
    faqs: [
      {
        q: "Is AP Calculus BC harder than AB?",
  ...
  "ap-chemistry": {
    keywords: ["AP Chemistry tutor", "AP Chemistry tutoring online", "AP Chemistry tutor near me", "private AP Chemistry tutor", "1:1 AP Chemistry tutoring", "AP Chemistry tutor for a 5", "best AP Chemistry tutor", "AP Chemistry tutor reviews", "AP Chemistry exam tutor", "AP Chemistry homework help", "live AP Chemistry tutor", "AP Chemistry tutor for international students", "AP Chemistry practice test tutor", "AP Chemistry FRQ tutor", "online AP Chemistry tutoring program", "AP Chemistry crash course tutor", "AP Chemistry tutor for high schoolers", "certified AP Chemistry tutor", "affordable AP Chemistry tutor", "Indian tutor for AP Chemistry", "AP Chemistry Indian tutor", "AP Chemistry online Indian tutor", "AP Chemistry tutor from India", "online AP Chemistry tutor in India", "hire Indian tutor for AP Chemistry"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["free-response mixes multi-step calculations and lab-data questions", "equilibrium, thermodynamics, electrochemistry drive quantitative sections", "equation reference sheet only helps if applied correctly", "stoichiometry and equilibrium underpin most later units"],
    faqs: [
      {
  ...
  "ap-biology": {
    ...
    subjectDetailHighlights: ["six free-response questions, many data-analysis based", "built around four recurring \"Big Ideas\" themes", "statistics formula sheet covers std deviation, chi-square", "tests graph and data interpretation, not just recall"],
    faqs: [
      {
  ...
  "gcse-chemistry": {
    keywords: ["GCSE Chemistry tutor", "GCSE Chemistry tutoring online", "GCSE Chemistry tutor near me", "private GCSE Chemistry tutor", "1:1 GCSE Chemistry tutoring", "AQA GCSE Chemistry tutor", "Edexcel GCSE Chemistry tutor", "OCR GCSE Chemistry tutor", "GCSE Triple Science Chemistry tutor", "GCSE Chemistry tutor required practicals", "online GCSE Chemistry tutor for international students", "hire GCSE Chemistry tutor online", "live GCSE Chemistry tutor online", "best GCSE Chemistry tutor online", "GCSE Chemistry tutor reviews", "GCSE Chemistry tutor foundation and higher tier", "GCSE Chemistry tutor exam technique", "Indian tutor for GCSE Chemistry", "GCSE Chemistry Indian tutor", "GCSE Chemistry online Indian tutor", "GCSE Chemistry tutor from India", "online GCSE Chemistry tutor in India", "hire Indian tutor for GCSE Chemistry"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["required practicals examined via written exam questions", "foundation tier caps at grade 5, higher spans 4-9", "combined science route condensed vs triple science depth", "periodic table provided, but using it is a skill"],
    faqs: [
      {
  ...
  "gcse-physics": {
    keywords: ["GCSE Physics tutor", "GCSE Physics tutoring online", "GCSE Physics tutor near me", "private GCSE Physics tutor", "1:1 GCSE Physics tutoring", "AQA GCSE Physics tutor", "Edexcel GCSE Physics tutor", "OCR GCSE Physics tutor", "GCSE Triple Science Physics tutor", "GCSE Physics tutor required practicals", "online GCSE Physics tutor for international students", "hire GCSE Physics tutor online", "live GCSE Physics tutor online", "best GCSE Physics tutor online", "GCSE Physics tutor reviews", "GCSE Physics tutor foundation and higher tier", "GCSE Physics tutor exam technique", "Indian tutor for GCSE Physics", "GCSE Physics Indian tutor", "GCSE Physics online Indian tutor", "GCSE Physics tutor from India", "online GCSE Physics tutor in India", "hire Indian tutor for GCSE Physics"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["many equations must be memorized, not provided", "required practicals tested via circuit and heat-capacity questions", "covers forces, energy, waves, electricity, magnetism", "triple science adds particle physics and astronomy"],
    faqs: [
      {
  ...
  "gcse-maths": {
    keywords: ["GCSE Maths tutor", "GCSE Maths tutoring online", "GCSE Maths tutor near me", "private GCSE Maths tutor", "1:1 GCSE Maths tutoring", "AQA GCSE Maths tutor", "Edexcel GCSE Maths tutor", "OCR GCSE Maths tutor", "GCSE Maths Foundation tier tutor", "GCSE Maths Higher tier tutor", "GCSE Maths resit tutor online", "online GCSE Maths tutor for international students", "hire GCSE Maths tutor online", "live GCSE Maths tutor online", "best GCSE Maths tutor online", "GCSE Maths tutor reviews", "GCSE Maths tutor grade 9 preparation", "Indian tutor for GCSE Maths", "GCSE Maths Indian tutor", "GCSE Maths online Indian tutor", "GCSE Maths tutor from India", "online GCSE Maths tutor in India", "hire Indian tutor for GCSE Maths"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["three papers: one non-calculator, two calculator", "foundation caps grade 5, higher adds surds and trig", "trouble spots: algebra manipulation and ratio word problems", "trigonometry and vectors are new territory late on"],
    faqs: [
      {
  ...
  "igcse-chemistry": {
    keywords: ["IGCSE Chemistry tutor", "IGCSE Chemistry tutoring online", "IGCSE Chemistry tutor near me", "private IGCSE Chemistry tutor", "1:1 IGCSE Chemistry tutoring", "Cambridge IGCSE Chemistry tutor", "Edexcel IGCSE Chemistry tutor", "IGCSE Chemistry tutor for international students", "IGCSE Chemistry tutor past papers", "IGCSE Chemistry tutor grade 9 A*", "hire IGCSE Chemistry tutor online", "live IGCSE Chemistry tutor online", "best IGCSE Chemistry tutor online", "IGCSE Chemistry tutor for expat families", "IGCSE Chemistry tutor syllabus 0620", "IGCSE Chemistry tutor reviews", "Indian tutor for IGCSE Chemistry", "IGCSE Chemistry Indian tutor", "IGCSE Chemistry online Indian tutor", "IGCSE Chemistry tutor from India", "online IGCSE Chemistry tutor in India", "hire Indian tutor for IGCSE Chemistry"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["core and extended tiers, distinct from GCSE grading", "\"alternative to practical\" written paper option exists", "core content overlaps GCSE: bonding, acids, organic basics", "pacing varies widely between international schools"],
    faqs: [
      {
  ...
  "igcse-physics": {
    keywords: ["IGCSE Physics tutor", "IGCSE Physics tutoring online", "IGCSE Physics tutor near me", "private IGCSE Physics tutor", "1:1 IGCSE Physics tutoring", "Cambridge IGCSE Physics tutor", "Edexcel IGCSE Physics tutor", "IGCSE Physics tutor for international students", "IGCSE Physics tutor past papers", "IGCSE Physics tutor grade 9 A*", "hire IGCSE Physics tutor online", "live IGCSE Physics tutor online", "best IGCSE Physics tutor online", "IGCSE Physics tutor for expat families", "IGCSE Physics tutor syllabus 0625", "IGCSE Physics tutor reviews", "Indian tutor for IGCSE Physics", "IGCSE Physics Indian tutor", "IGCSE Physics online Indian tutor", "IGCSE Physics tutor from India", "online IGCSE Physics tutor in India", "hire Indian tutor for IGCSE Physics"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["topic ordering differs from GCSE despite similar level", "core and extended tiers, plus alternative-to-practical option", "common stepping stone into A-Level or IB physics", "vector quantities and circuit-analysis gaps often resurface later"],
    faqs: [
      {
  ...
  "igcse-maths": {
    keywords: ["IGCSE Maths tutor", "IGCSE Maths tutoring online", "IGCSE Maths tutor near me", "private IGCSE Maths tutor", "1:1 IGCSE Maths tutoring", "Cambridge IGCSE Maths tutor", "Edexcel IGCSE Maths tutor", "IGCSE Maths tutor for international students", "IGCSE Maths tutor past papers", "IGCSE Maths extended core tutor", "hire IGCSE Maths tutor online", "live IGCSE Maths tutor online", "best IGCSE Maths tutor online", "IGCSE Maths tutor for expat families", "IGCSE Maths tutor reviews", "IGCSE Additional Maths tutor", "Indian tutor for IGCSE Maths", "IGCSE Maths Indian tutor", "IGCSE Maths online Indian tutor", "IGCSE Maths tutor from India", "online IGCSE Maths tutor in India", "hire Indian tutor for IGCSE Maths"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["extra emphasis on matrices, set and function notation", "extended tier includes trig depth and calculus basics", "diagnostic check on algebra basics often needed first", "ratio and modeling word problems a common sticking point"],
    faqs: [
      {
  ...
  "a-level-chemistry": {
    ...
    subjectDetailHighlights: ["practical endorsement graded separately from final A*-E score", "written papers still test practical knowledge indirectly", "physical, inorganic, organic strands run in parallel", "organic chemistry rewards mechanism pattern recognition"],
    faqs: [
      {
  ...
  "a-level-physics": {
    keywords: ["A-Level Physics tutor", "A-Level Physics tutoring online", "A-Level Physics tutor near me", "private A-Level Physics tutor", "1:1 A-Level Physics tutoring", "AQA A-Level Physics tutor", "Edexcel A-Level Physics tutor", "OCR A-Level Physics tutor", "WJEC A-Level Physics tutor", "online A-Level Physics tutor for international students", "A-Level Physics tutor for astrophysics", "A-Level Physics tutor for electromagnetism", "hire A-Level Physics tutor online", "live A-Level Physics tutor online", "best A-Level Physics tutor online", "A-Level Physics tutor reviews", "A-Level Physics tutor past papers", "A-Level Physics tutor for expat students", "Indian tutor for A-Level Physics", "A-Level Physics Indian tutor", "A-Level Physics online Indian tutor", "A-Level Physics tutor from India", "online A-Level Physics tutor in India", "hire Indian tutor for A-Level Physics"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["mathematical step-up bigger than GCSE, some calculus", "covers particle physics, quantum phenomena, and an optional topic", "practical endorsement assessed separately from final grade", "exam board choice affects content sequencing and phrasing"],
    faqs: [
      {
  ...
  "a-level-maths": {
    keywords: ["A-Level Maths tutor", "A-Level Maths tutoring online", "A-Level Maths tutor near me", "private A-Level Maths tutor", "1:1 A-Level Maths tutoring", "AQA A-Level Maths tutor", "Edexcel A-Level Maths tutor", "OCR A-Level Maths tutor", "A-Level Maths resit tutor", "A-Level Maths retake tutor online", "online A-Level Maths tutor for international students", "hire A-Level Maths tutor online", "live A-Level Maths tutor online", "best A-Level Maths tutor online", "A-Level Maths tutor reviews", "A-Level Maths tutor for pure maths", "A-Level Maths tutor for statistics and mechanics", "A-Level Maths tutor for expat families", "Indian tutor for A-Level Maths", "A-Level Maths Indian tutor", "A-Level Maths online Indian tutor", "A-Level Maths tutor from India", "online A-Level Maths tutor in India", "hire Indian tutor for A-Level Maths"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["fully linear qualification, graded from year-13 exams only", "statistics and mechanics compulsory alongside pure maths", "pure maths carries the largest share of marks", "assumes strong GCSE algebra before calculus begins"],
    faqs: [
      {
  ...
  "gcse-biology": {
    keywords: ["GCSE Biology tutor", "GCSE Biology tutoring online", "GCSE Biology tutor near me", "private GCSE Biology tutor", "1:1 GCSE Biology tutoring", "AQA GCSE Biology tutor", "Edexcel GCSE Biology tutor", "OCR GCSE Biology tutor", "GCSE Biology tutor required practicals", "GCSE Triple Science Biology tutor", "online GCSE Biology tutor for international students", "hire GCSE Biology tutor online", "live GCSE Biology tutor online", "best GCSE Biology tutor online", "GCSE Biology tutor reviews", "GCSE Biology tutor foundation and higher tier", "GCSE Biology tutor past papers help", "Indian tutor for GCSE Biology", "GCSE Biology Indian tutor", "GCSE Biology online Indian tutor", "GCSE Biology tutor from India", "online GCSE Biology tutor in India", "hire Indian tutor for GCSE Biology"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["content split across two papers per exam board", "required practicals examined within written papers, not coursework", "genetics calculations like punnett squares a trouble spot", "command-word mix-ups (\"describe\" vs \"explain\") cost marks"],
    faqs: [
      {
  ...
  "gcse-science": {
    keywords: ["GCSE Science tutor", "GCSE Science tutoring online", "GCSE Science tutor near me", "private GCSE Science tutor", "1:1 GCSE Science tutoring", "GCSE Combined Science tutor", "GCSE Combined Science Trilogy tutor", "GCSE Combined Science Synergy tutor", "GCSE Double Award Science tutor", "AQA GCSE Combined Science tutor", "online GCSE Science tutor for international students", "hire GCSE Science tutor online", "live GCSE Science tutor online", "best GCSE Science tutor online", "GCSE Science tutor foundation and higher tier", "GCSE Combined Science tutor reviews", "GCSE Science resit tutor online", "Indian tutor for GCSE Science", "GCSE Science Indian tutor", "GCSE Science online Indian tutor", "GCSE Science tutor from India", "online GCSE Science tutor in India", "hire Indian tutor for GCSE Science"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["six papers combine into one double grade", "reduced depth compared to triple science route", "one weak paper can drag down whole grade", "required practicals assessed through written exam questions"],
    faqs: [
      {
  ...
  "gcse-english": {
    keywords: ["GCSE English tutor", "GCSE English tutoring online", "GCSE English tutor near me", "private GCSE English tutor", "1:1 GCSE English tutoring", "GCSE English Language tutor online", "GCSE English Literature tutor online", "AQA GCSE English tutor", "GCSE English tutor exam board specialist", "GCSE English Literature Macbeth tutor", "GCSE English Language creative writing tutor", "online GCSE English tutor for international students", "hire GCSE English tutor online", "live GCSE English tutor online", "best GCSE English tutor online", "GCSE English tutor exam technique grade 9", "GCSE English tutor for non-native speakers", "Indian tutor for GCSE English", "GCSE English Indian tutor", "GCSE English online Indian tutor", "GCSE English tutor from India", "online GCSE English tutor in India", "hire Indian tutor for GCSE English"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["language tests unseen extracts and original writing", "literature built around memorized set-text quotations", "set texts include shakespeare, a novel, and poetry", "command words rewarded differently in each paper"],
    faqs: [
      {
  ...
  "a-level-further-maths": {
    keywords: ["A-Level Further Maths tutor", "A-Level Further Maths tutoring online", "A-Level Further Maths tutor near me", "private A-Level Further Maths tutor", "1:1 A-Level Further Maths tutoring", "AQA A-Level Further Maths tutor", "Edexcel A-Level Further Maths tutor", "OCR A-Level Further Maths tutor", "A-Level Further Maths tutor Core Pure", "A-Level Further Maths tutor for international students", "A-Level Further Maths resit tutor", "hire A-Level Further Maths tutor online", "live A-Level Further Maths tutor online", "A-Level Further Maths tutor reviews", "best A-Level Further Maths tutor online", "A-Level Further Maths tutor past papers", "A-Level Further Maths tutor for expat students", "Indian tutor for A-Level Further Maths", "A-Level Further Maths Indian tutor", "A-Level Further Maths online Indian tutor", "A-Level Further Maths tutor from India", "online A-Level Further Maths tutor in India", "hire Indian tutor for A-Level Further Maths"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["compulsory core: complex numbers, matrices, polar coordinates", "applied options vary: mechanics, statistics, or decision maths", "matrices and complex numbers are entirely new topics", "studied alongside standard maths, reusing core calculus skills"],
    faqs: [
      {
  ...
  "ib-math": {
    keywords: ["IB Math tutor", "IB Math tutoring online", "IB Math tutor near me", "private IB Math tutor", "1:1 IB Math tutoring", "IB Math AA tutor", "IB Math AI tutor", "IB Math HL tutor", "IB Math SL tutor", "IB Math IA tutor", "hire IB Math tutor online", "live IB Math tutor online", "best IB Math tutor online", "IB Math tutor for expat students", "IB Math tutor reviews", "IB Math tutor online worldwide", "Indian tutor for IB Math", "IB Math Indian tutor", "IB Math online Indian tutor", "IB Math tutor from India", "online IB Math tutor in India", "hire Indian tutor for IB Math"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["AA and AI are different in kind, not difficulty", "AI covers statistics, financial maths, and graph theory", "AA stays close to traditional pure-maths sequence", "exploration is a 6-to-12-page independent research piece"],
    faqs: [
      {
  ...
  "ib-physics": {
    keywords: ["IB Physics tutor", "IB Physics tutoring online", "IB Physics tutor near me", "private IB Physics tutor", "1:1 IB Physics tutoring", "IB Physics HL tutor", "IB Physics SL tutor", "IB Physics IA tutor", "IB Physics tutor online worldwide", "hire IB Physics tutor online", "live IB Physics tutor online", "best IB Physics tutor online", "IB Physics tutor for expat students", "IB Physics extended essay tutor", "IB Physics tutor reviews", "IB Physics tutor exam paper 1 2 3", "Indian tutor for IB Physics", "IB Physics Indian tutor", "IB Physics online Indian tutor", "IB Physics tutor from India", "online IB Physics tutor in India", "hire Indian tutor for IB Physics"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["IA is a self-designed experiment, like pendulum period", "graded on investigation design, not a \"correct\" answer", "HL adds astrophysics or particle-physics depth at faster pace", "graph interpretation and unit consistency are common sticking points"],
    faqs: [
      {
  ...
  "ib-chemistry": {
    ...
    subjectDetailHighlights: ["mole calculations underpin equilibrium and later topics", "organic chemistry rewards pattern recognition, not calculation", "HL adds depth across topics plus an extra paper", "IA is a student-designed practical investigation"],
    faqs: [
      {
        q: "HL or SL — does it matter?",
  ...
  "international-baccalaureate-ib": {
    keywords: ["an IB tutor", "International Baccalaureate (IB) tutoring online", "International Baccalaureate (IB) tutor near me", "private International Baccalaureate (IB) tutor", "1:1 International Baccalaureate (IB) tutoring", "IB Diploma Programme tutor", "IB tutor for all subjects", "best IB tutoring company", "IB tutor examiner qualified", "IB tutor for expat families worldwide", "hire IB tutor online", "live IB tutor online", "IB Extended Essay tutor", "IB Theory of Knowledge tutor", "IB tutor for international school students", "IB tutoring companies reviews", "IB tutor for MYP and DP", "Indian tutor for International Baccalaureate (IB)", "International Baccalaureate (IB) Indian tutor", "International Baccalaureate (IB) online Indian tutor", "International Baccalaureate (IB) tutor from India", "online International Baccalaureate (IB) tutor in India", "hire Indian tutor for International Baccalaureate (IB)"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    differentiation:
    ...
    subjectDetailHighlights: ["six subjects across six mandated groups", "core adds Theory of Knowledge, Extended Essay, and CAS", "scored out of 45, including bonus TOK/EE points", "extended essay is a roughly 4,000-word research paper"],
    faqs: [
      {
  ...
  "sat-math": {
    keywords: ["SAT Math tutor", "SAT Math tutoring online", "SAT Math tutor near me", "private SAT Math tutor", "1:1 SAT Math tutoring", "digital SAT Math tutor", "SAT Math tutor for a perfect 800", "best SAT Math tutor", "SAT Math tutor reviews", "SAT Math homework help", "live SAT Math tutor", "SAT Math tutor for international students", "SAT Math practice test tutor", "online SAT Math tutoring program", "SAT Math crash course tutor", "SAT Math tutor for high schoolers", "certified SAT Math tutor", "SAT Math score improvement tutor", "99th percentile SAT Math tutor", "Indian tutor for SAT Math", "SAT Math Indian tutor", "SAT Math online Indian tutor", "SAT Math tutor from India", "online SAT Math tutor in India", "hire Indian tutor for SAT Math"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["two adaptive modules, difficulty set by first module", "calculator, including built-in desmos, allowed throughout", "algebra and advanced math make up largest share", "over-relying on calculator can waste time"],
    faqs: [
      {
  ...
  "sat-english": {
    keywords: ["SAT English tutor", "SAT English tutoring online", "SAT English tutor near me", "private SAT English tutor", "1:1 SAT English tutoring", "SAT Reading and Writing tutor", "digital SAT English tutor", "SAT English tutor for top score", "best SAT English tutor", "SAT English tutor reviews", "SAT Reading tutor online", "SAT Writing and Language tutor", "SAT English homework help", "live SAT English tutor", "SAT English tutor for international students", "SAT English practice test tutor", "online SAT English tutoring program", "SAT English crash course tutor", "certified SAT English tutor", "Indian tutor for SAT English", "SAT English Indian tutor", "SAT English online Indian tutor", "SAT English tutor from India", "online SAT English tutor in India", "hire Indian tutor for SAT English"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["short passages paired one-to-one with single questions", "two adaptive modules, same format as SAT math", "covers grammar conventions plus rhetorical synthesis and transitions", "over-reading short passages is a common trap"],
    faqs: [
      {
  ...
  "act-math": {
    keywords: ["ACT Math tutor", "ACT Math tutoring online", "ACT Math tutor near me", "private ACT Math tutor", "1:1 ACT Math tutoring", "ACT Math tutor for a 36", "best ACT Math tutor", "ACT Math tutor reviews", "ACT Math prep tutor", "ACT Math homework help", "live ACT Math tutor", "ACT Math tutor for international students", "ACT Math practice test tutor", "online ACT Math tutoring program", "ACT Math crash course tutor", "ACT Math tutor for high schoolers", "certified ACT Math tutor", "ACT Math score improvement tutor", "99th percentile ACT Math tutor", "Indian tutor for ACT Math", "ACT Math Indian tutor", "ACT Math online Indian tutor", "ACT Math tutor from India", "online ACT Math tutor in India", "hire Indian tutor for ACT Math"],
    template: "service-hybrid",
    showGuaranteeLink: true,
    ...
    subjectDetailHighlights: ["fixed question order, not adaptive like the SAT", "60 questions in 60 minutes, a fast pace", "draws more consistently on trigonometry and geometry", "pacing and skip strategy matter, questions weigh equally"],
    faqs: [
      {
  ...
  "cambridge-english": {
    ...
    subjectDetailHighlights: ["separate exam per level, unlike IELTS's single band scale", "FCE/CAE combine reading and use-of-english into one paper", "use of english tests grammar directly via cloze exercises", "narrowly failing still earns a lower-level certificate"],
    faqs: [
      {
  ...
  "javascript": {
    ...
    subjectDetailHighlights: ["runs in-browser, reacting to clicks and events", "Node.js reuses the language for servers, no DOM", "`==` vs `===` type coercion trips up beginners", "async code and closures are recurring sticking points"],
    faqs: [
      {
  ...
  "python": {
    ...
    subjectDetailHighlights: ["moves from core syntax to lists, dicts, sets, tuples", "progresses toward building a real project, not just exercises", "indentation errors trip up newcomers from other languages", "mutable-default-argument bugs are a common pitfall"],
    faqs: [
      {
  ...
  "c": {
    ...
    subjectDetailHighlights: ["pointers are the biggest conceptual wall for beginners", "segfaults come from uninitialized or freed pointers", "manual malloc and free replace automatic memory management", "arrays lack bounds checking, corrupting memory silently"],
    faqs: [
      {
  ...
  "sql": {
    ...
    subjectDetailHighlights: ["missing join conditions create unintended cartesian products", "inner join drops unmatched rows, left join keeps them", "group by errors when selecting non-aggregated columns", "reasoning about a specific schema matters more than syntax"],
    faqs: [
      {
  ...
  "java": {
    ...
    subjectDetailHighlights: ["strict object-oriented structure, everything lives in a class", "compiles to bytecode run by the JVM everywhere", "static typing catches errors before the program runs", "`==` vs `.equals()` confusion causes common bugs"],
    faqs: [
      {
  ...
  "html": {
    ...
    subjectDetailHighlights: ["semantic tags like nav and article beat generic divs", "matters for screen readers and accessibility tools", "every page needs a doctype, head, and body skeleton", "alt text on images is often skipped early on"],
    faqs: [
      {
  ...
  "ai-basics": {
    ...
    subjectDetailHighlights: ["what a model actually is: a trained function", "training vs inference: learning patterns vs predicting", "decision trees and simple classification models", "hands-on low-code projects like spam classifiers"],
    faqs: [
      {
  ...
  // ---------------------------------------------------------------------
  "astronomy": {
    keywords: ["Astronomy tutor", "Astronomy tutoring online", "Astronomy tutor near me", "private Astronomy tutor", "1:1 Astronomy tutoring", "Astronomy homework help", "astronomy homework help online", "online astronomy course tutor", "astrophysics tutor online", "college astronomy tutor online", "introductory astronomy tutor", "astronomy exam prep tutor", "astronomy assignment help online", "certified astronomy tutor online", "affordable astronomy tutoring online", "one-on-one astronomy lessons online", "astronomy tutor for college students", "astronomy lab report help", "Indian tutor for Astronomy", "Astronomy Indian tutor", "Astronomy online Indian tutor", "Astronomy tutor from India", "online Astronomy tutor in India", "hire Indian tutor for Astronomy"],
    template: "standard",
    ...
    subjectDetailHighlights: ["reading star charts, magnitude, angular size", "theoretical side: star color, temperature, elliptical orbits", "scale: light-years, parsecs, astronomical units", "star life cycle and basic cosmology"],
    faqs: [
  ...
  "genetics": {
    ...
    subjectDetailHighlights: ["Mendelian crosses and Punnett squares", "meiosis and how gametes carry genes", "DNA structure, transcription, and translation", "pedigree analysis, PCR, and gene editing"],
    faqs: [
  ...
  "human-anatomy": {
    ...
    subjectDetailHighlights: ["systems-first approach: skeletal, muscular, circulatory", "Latin and Greek roots behind anatomical terms", "directional language: anterior, posterior, medial, lateral"],
    faqs: [
  ...
  "calculus": {
    ...
    subjectDetailHighlights: ["limits as the foundation before derivatives", "derivative rules: power, product, chain", "related rates, optimization, curve sketching", "Fundamental Theorem linking derivatives and integrals"],
    faqs: [
  ...
  "physics": {
    ...
    subjectDetailHighlights: ["translating real scenarios into the right equation", "mechanics, electricity and magnetism, waves and optics", "thermodynamics and intro modern physics topics", "common misconceptions like current 'running out'"],
    faqs: [
  ...
  "mathematics": {
    keywords: ["Mathematics tutor", "Mathematics tutoring online", "Mathematics tutor near me", "private Mathematics tutor", "1:1 Mathematics tutoring", "Mathematics homework help", "elementary math tutor online", "middle school math tutor online", "high school math tutor online", "math word problems help online", "K-12 math tutor online", "certified math tutor online", "one-on-one math lessons online", "affordable math tutoring online", "math test prep tutor online", "math tutor for college students", "24/7 math tutor online", "math tutor for kids online", "Indian tutor for Mathematics", "Mathematics Indian tutor", "Mathematics online Indian tutor", "Mathematics tutor from India", "online Mathematics tutor in India", "hire Indian tutor for Mathematics"],
    template: "standard",
    ...
    subjectDetailHighlights: ["broad numeracy spanning several topics at once", "diagnosing which specific branch is the gap", "key transition points: algebra, proof, calculus", "refreshers for adult learners returning to math"],
    faqs: [
  ...
  "mechanics": {
    ...
    subjectDetailHighlights: ["kinematics vs dynamics: describing vs explaining motion", "Newton's second law and free-body diagrams", "energy methods: work, kinetic and potential energy", "rotational motion: torque and angular momentum"],
    faqs: [
  ...
  "organic-chemistry": {
    ...
    subjectDetailHighlights: ["functional groups driving molecular reactivity", "electron movement: nucleophiles, electrophiles, curved arrows", "core mechanisms: substitution, addition, elimination", "stereochemistry and three-dimensional molecular shape"],
    faqs: [
  ...
  "biology": {
    ...
    subjectDetailHighlights: ["cell structure, respiration, and photosynthesis", "organs and organ systems built from cells", "ecology: populations, ecosystems, energy flow", "evolution as a connecting thread throughout"],
    faqs: [
  ...
  "chemistry": {
    ...
    subjectDetailHighlights: ["atomic structure and periodic table logic", "ionic and covalent bonding, molecular shapes", "stoichiometry: balancing equations, mole conversions", "acid-base, equilibrium, and reaction-rate topics"],
    faqs: [
  ...
  "geometry": {
    ...
    subjectDetailHighlights: ["formal proof writing and logical justification", "triangle, circle, and polygon theorems", "coordinate geometry: lines, slopes, distances", "spatial reasoning: rotations, cross-sections, transformations"],
    faqs: [
  ...
  "trigonometry": {
    ...
    subjectDetailHighlights: ["right-triangle ratios: sine, cosine, tangent", "unit circle, radians, angles beyond 90 degrees", "identities like the Pythagorean and angle-sum formulas", "modeling periodic phenomena: waves, tides, sound"],
    faqs: [
  ...
  "advanced-algebra": {
    ...
    subjectDetailHighlights: ["functions' domain, range, and graph transformations", "polynomial factoring, roots, and end behavior", "exponential and logarithmic function behavior", "systems of equations, including matrix methods"],
    faqs: [
  ...
  "algebra-i": {
    ...
    subjectDetailHighlights: ["isolating variables using inverse operations", "slope-intercept form and graphing lines", "solving systems by substitution or elimination", "translating word problems into equations"],
    faqs: [
  ...
  "algebra-ii": {
    ...
    subjectDetailHighlights: ["quadratics: factoring, completing the square, graphing", "higher-degree polynomials and rational expressions", "exponential growth and decay, logarithms", "complex numbers from non-real quadratic roots"],
    faqs: [
  ...
  "pre-algebra": {
    ...
    subjectDetailHighlights: ["order of operations and negative numbers", "converting fractions, decimals, and percentages", "variables representing an unknown number", "proportional reasoning: rates, ratios, scale"],
    faqs: [
  ...
  "probability": {
    ...
    subjectDetailHighlights: ["permutations vs combinations in counting problems", "compound and conditional probability, independence", "the difference between 'or' and 'and' rules", "Bayes' theorem and binomial or normal distributions"],
    faqs: [
  ...
  "precalculus": {
    ...
    subjectDetailHighlights: ["unit circle, radians, and trig graphing", "function composition, inverses, piecewise functions", "polar coordinates and vectors", "limits introduced as a calculus preview"],
    faqs: [
  ...
  "statistics": {
    ...
    subjectDetailHighlights: ["descriptive stats: mean, median, standard deviation", "hypothesis testing, confidence intervals, p-values", "why correlation is not causation", "choosing the right test: t-test vs chi-square"],
    faqs: [
  ...
  "environmental-science": {
    ...
    subjectDetailHighlights: ["ecosystems, biomes, and population dynamics", "carbon, nitrogen, and water cycles", "pollution, resource depletion, and climate systems", "reading population growth and climate data"],
    faqs: [
  ...
  "english": {
    ...
    subjectDetailHighlights: ["spans reading, vocabulary, grammar, and writing", "literature analysis: theme, characterization, author's choices", "reading comprehension: argument and implied meaning", "identifying which specific skill is the gap"],
    faqs: [
  ...
  "academic-english": {
    ...
    subjectDetailHighlights: ["academic register and vocabulary vs everyday speech", "hedging claims and citing sources properly", "cohesion: linking ideas with connective language", "academic listening and lecture note-taking"],
    faqs: [
  ...
  "academic-writing": {
    keywords: ["Academic Writing tutor", "Academic Writing tutoring online", "Academic Writing tutor near me", "private Academic Writing tutor", "1:1 Academic Writing tutoring", "Academic Writing tutor for ESL students", "Academic Writing tutor for college students", "Academic Writing tutor for graduate students", "thesis writing tutor online", "research paper writing tutor", "Academic Writing tutor for international students", "Academic Writing tutor for citations and plagiarism", "Academic Writing tutor for essay structure", "Academic Writing tutor for non-native English speakers", "Academic Writing tutor for university applications", "Academic Writing tutor for dissertation help", "Academic Writing tutor for argumentative essays", "Indian tutor for Academic Writing", "Academic Writing Indian tutor", "Academic Writing online Indian tutor", "Academic Writing tutor from India", "online Academic Writing tutor in India", "hire Indian tutor for Academic Writing"],
    template: "standard",
    ...
    subjectDetailHighlights: ["forming a clear, arguable thesis", "organizing evidence to support an argument", "paraphrasing, quoting, and citing sources", "revision beyond a single first draft"],
    faqs: [
  ...
  "essay-writing": {
    keywords: ["Essay Writing tutor", "Essay Writing tutoring online", "Essay Writing tutor near me", "private Essay Writing tutor", "1:1 Essay Writing tutoring", "Essay Writing tutor for college applications", "Essay Writing tutor for personal statements", "Essay Writing tutor for SAT prep", "Essay Writing tutor for ACT prep", "Essay Writing tutor for high school students", "Essay Writing tutor for college admissions", "Essay Writing tutor for brainstorming and outlining", "Essay Writing tutor for editing and feedback", "Essay Writing tutor for argumentative essays", "Essay Writing tutor for scholarship essays", "Essay Writing tutor for supplemental essays", "Essay Writing tutor for thesis statements", "Indian tutor for Essay Writing", "Essay Writing Indian tutor", "Essay Writing online Indian tutor", "Essay Writing tutor from India", "online Essay Writing tutor in India", "hire Indian tutor for Essay Writing"],
    template: "standard",
    ...
    subjectDetailHighlights: ["turning a prompt into a defensible thesis", "topic sentences, evidence, and analysis in paragraphs", "conclusions and transitions that connect the argument", "timed, exam-style essay practice"],
    faqs: [
  ...
  "creative-writing": {
    ...
    subjectDetailHighlights: ["'show, don't tell' through sensory detail", "character development: a clear want and flaw", "dialogue, pacing, and point of view", "poetry craft: line breaks, imagery, sound devices"],
    faqs: [
  ...
  "grammar": {
    ...
    subjectDetailHighlights: ["subject-verb agreement, even with tricky phrasing", "consistent verb tense and correct pronoun use", "comma splices, run-ons, and fragments", "formal writing rules vs casual habits"],
    faqs: [
  ...
  "vocabulary": {
    ...
    subjectDetailHighlights: ["Greek and Latin roots like bio and tele", "using context clues to guess meaning", "active practice using new words in sentences", "confusable pairs like affect and effect"],
    faqs: [
  ...
  "reading-comprehension": {
    keywords: ["Reading Comprehension tutor", "Reading Comprehension tutoring online", "Reading Comprehension tutor near me", "private Reading Comprehension tutor", "1:1 Reading Comprehension tutoring", "Reading Comprehension tutor for struggling readers", "Reading Comprehension tutor for kids", "Reading Comprehension strategies tutor online", "Reading Comprehension tutor for elementary students", "Reading Comprehension tutor for dyslexia", "Reading Comprehension tutor for phonics", "Reading Comprehension tutor for middle school", "Reading Comprehension tutor for test prep", "Reading Comprehension tutor for active reading skills", "Reading Comprehension tutor for vocabulary building", "Reading Comprehension tutor for critical thinking", "Reading Comprehension tutor for beginners", "Indian tutor for Reading Comprehension", "Reading Comprehension Indian tutor", "Reading Comprehension online Indian tutor", "Reading Comprehension tutor from India", "online Reading Comprehension tutor in India", "hire Indian tutor for Reading Comprehension"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["literal vs inferential understanding of a text", "main idea versus supporting details", "citing specific textual evidence for answers", "different strategies for nonfiction vs fiction"],
    faqs: [
  ...
  "literature": {
    ...
    subjectDetailHighlights: ["moving from plot summary to interpretive argument", "identifying devices: symbolism, foreshadowing, unreliable narrators", "close, quotable reading of set texts", "genre-specific tools for poetry, novels, or plays"],
    faqs: [
  ...
  // ---------------------------------------------------------------------
  "biology-basics": {
    keywords: ["Biology Basics tutor", "Biology Basics tutor for middle school", "Biology Basics homework help", "private Biology Basics tutor", "1:1 Biology Basics tutoring", "online biology tutor for 6th graders", "biology tutor for 7th grade", "biology tutor for 8th grade", "cell structure tutor for kids", "biology basics online classes for kids", "middle school life science tutor", "biology vocabulary help online", "biology basics test prep tutor", "ecology and genetics tutor for kids", "biology tutor for beginners online", "science fair biology help tutor", "biology basics tutor for homeschool", "biology basics tutor abroad", "biology basics tutoring for international students", "human body basics tutor for kids", "Indian tutor for Biology Basics", "Biology Basics Indian tutor", "Biology Basics online Indian tutor", "Biology Basics tutor from India", "online Biology Basics tutor in India", "hire Indian tutor for Biology Basics"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["basic characteristics of life: growth, cells, response", "cell structure: organelles, plant vs animal cells", "classification from kingdom down to species", "food chains and human body systems overview"],
    faqs: [
  ...
  "chemistry-basics": {
    keywords: ["Chemistry Basics tutor", "Chemistry Basics tutor for middle school", "Chemistry Basics homework help", "private Chemistry Basics tutor", "1:1 Chemistry Basics tutoring", "chemistry tutor for middle schoolers", "chemistry basics online classes for kids", "atoms and elements tutor for kids", "chemistry basics tutor for beginners", "balancing equations tutor for kids", "chemistry basics tutor for homeschool", "chemistry basics test prep tutor", "periodic table tutor for kids", "chemistry basics tutoring for 8th grade", "chemistry basics tutor abroad", "simple chemical reactions tutor for kids", "chemistry basics tutor near me online", "chemistry basics tutoring for international students", "intro chemistry tutor for teens", "chemistry basics homeschool support tutor", "Indian tutor for Chemistry Basics", "Chemistry Basics Indian tutor", "Chemistry Basics online Indian tutor", "Chemistry Basics tutor from India", "online Chemistry Basics tutor in India", "hire Indian tutor for Chemistry Basics"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["states of matter and physical vs chemical change", "intro to atoms, elements, and the periodic table", "elements, compounds, and mixtures compared", "basic lab safety and measurement skills"],
    faqs: [
  ...
  "physics-basics": {
    ...
    subjectDetailHighlights: ["mass versus weight, and why they differ", "speed, velocity, and basic motion concepts", "simple machines: levers, pulleys, inclined planes", "kinetic vs potential energy, common force myths"],
    faqs: [
  ...
  "general-mathematics": {
    ...
    subjectDetailHighlights: ["fraction and decimal operations", "ratios and proportional reasoning", "percentages tied to word problems", "negative numbers and basic expressions"],
    faqs: [
  ...
  "general-science": {
    keywords: ["General Science tutor", "General Science tutor for middle school", "General Science homework help", "private General Science tutor", "1:1 General Science tutoring", "general science tutor for homeschool", "general science online classes for kids", "general science tutor for exam prep", "general science tutor near me online", "general science homework help online", "general science tutor for international students", "general science vocabulary help tutor", "general science tutor for science fair", "general science tutor for curious kids", "general science tutor grade 6 to 8", "general science confidence building tutor", "general science tutor for beginners", "general science tutor abroad", "intro general science tutor for teens", "Indian tutor for General Science", "General Science Indian tutor", "General Science online Indian tutor", "General Science tutor from India", "online General Science tutor in India", "hire Indian tutor for General Science"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["life, earth, and physical science survey", "earth science: weather, rock cycle, plate tectonics", "hypothesis, control, and variable identification", "reading graphs and structured lab write-ups"],
    faqs: [
  ...
  "geometry-basics": {
    ...
    subjectDetailHighlights: ["area and perimeter of rectangles, triangles, circles", "volume and surface area of prisms, cylinders", "angle and shape vocabulary and classification", "coordinate plane, reflections, and rotations"],
    faqs: [
  ...
  "middle-school-math": {
    ...
    subjectDetailHighlights: ["spans number sense, ratios, geometry, algebra", "statistics: bar graphs, line plots, mean and median", "one-step and two-step equation basics", "bridges into formal Algebra I"],
    faqs: [
  ...
  // ---------------------------------------------------------------------
  "history": {
    keywords: ["History tutor", "History tutoring online", "History tutor near me", "private History tutor", "1:1 History tutoring", "history tutor for IB students", "IB history HL tutor online", "IB history SL tutor online", "AP world history tutor online", "AP US history tutor online", "AP European history tutor online", "IGCSE history tutor online", "A Level history tutor online", "history essay writing tutor online", "history DBQ help tutor online", "history tutor for expat students", "history tutor for international students", "history exam prep tutor online", "history source analysis tutor", "history tutor for high school", "Indian tutor for History", "History Indian tutor", "History online Indian tutor", "History tutor from India", "online History tutor in India", "hire Indian tutor for History"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["chronological reasoning and sequencing events", "causation vs. coincidence in timing", "primary source and document analysis", "comparative and thematic connections across eras"],
    faqs: [
  ...
  "geography": {
    keywords: ["Geography tutor", "Geography tutoring online", "Geography tutor near me", "private Geography tutor", "1:1 Geography tutoring", "geography tutor for IGCSE", "geography tutor for IB students", "IB geography HL tutor online", "IB geography SL tutor online", "A Level geography tutor online", "geography tutor for high school", "geography IA help tutor online", "geography tutor for expat students", "geography tutor for international students", "geography exam prep tutor online", "geography case study tutor online", "geography tutor for beginners", "geography homework help online", "physical geography tutor online", "human geography tutor online", "Indian tutor for Geography", "Geography Indian tutor", "Geography online Indian tutor", "Geography tutor from India", "online Geography tutor in India", "hire Indian tutor for Geography"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["physical geography: landforms, climate, weather", "human geography: population, migration, urbanization", "map literacy: scale, coordinates, choropleth maps", "regional case studies and current-events links"],
    faqs: [
  ...
  "civics": {
    ...
    subjectDetailHighlights: ["three branches of federal government", "federal vs. state vs. local authority", "citizenship rights: Bill of Rights, voting, jury duty", "how a bill becomes law"],
    faqs: [
  ...
  "finance-basics": {
    ...
    subjectDetailHighlights: ["income and budgeting: fixed vs. variable expenses", "simple vs. compound interest on savings", "credit and debt: rates, minimum payments", "risk, diversification, saving vs. investing"],
    faqs: [
  ...
  "economics": {
    ...
    subjectDetailHighlights: ["supply and demand price-setting", "market structures: competition to monopoly", "GDP, inflation, and unemployment", "fiscal and monetary policy tools"],
    faqs: [
  ...
  "accounting": {
    ...
    subjectDetailHighlights: ["core accounting equation: assets, liabilities, equity", "double-entry debits and credits", "journal entries, ledgers, trial balance", "income statement, balance sheet, cash flow"],
    faqs: [
      { q: "Is this for school coursework or professional certification?", a: "This subject is positioned for school-level students (Grades 9-12) — mention your specific need when requesting a tutor." },
  ...
  "business-studies": {
    keywords: ["Business Studies tutor", "Business Studies tutoring online", "Business Studies tutor near me", "private Business Studies tutor", "1:1 Business Studies tutoring", "business studies tutor for IGCSE", "business studies tutor for IB students", "IB business management tutor online", "A Level business studies tutor online", "business studies tutor for high school", "business studies exam prep tutor", "business studies tutor for international students", "business studies homework help online", "business studies tutor for expat students", "GCSE business studies tutor online", "business studies IA help tutor", "business studies case study tutor", "business studies tutor for beginners", "business studies tutor near me online", "business studies tutoring for teens", "Indian tutor for Business Studies", "Business Studies Indian tutor", "Business Studies online Indian tutor", "Business Studies tutor from India", "online Business Studies tutor in India", "hire Indian tutor for Business Studies"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["marketing: research, marketing mix, branding", "operations: production, supply chains, quality", "HR: recruitment, motivation, structure", "case-study analysis of business trade-offs"],
    faqs: [
      { q: "Is this for school coursework or professional certification?", a: "This subject is positioned for school-level students (Grades 9-12) — mention your specific need when requesting a tutor." },
  ...
  "spanish": {
    ...
    subjectDetailHighlights: ["gendered nouns and adjective agreement", "ser vs. estar distinction", "present-tense conjugation across verb groups", "false cognates and irregular verbs"],
    faqs: [
  ...
  "french": {
    ...
    subjectDetailHighlights: ["noun gender and adjective agreement", "passé composé vs. imparfait past tenses", "nasal vowels, silent consonants, liaison", "tu/vous formality distinction"],
    faqs: [
  ...
  "hindi": {
    ...
    subjectDetailHighlights: ["spoken fluency vs. Devanagari literacy path", "Devanagari script and vowel matras", "no articles, verb-final sentence order", "postpositions instead of prepositions"],
    faqs: [
  ...
  "arabic": {
    ...
    subjectDetailHighlights: ["Modern Standard Arabic vs. spoken dialects", "three-consonant root-and-pattern words", "right-to-left script, position-based letter shapes", "short vowels often unmarked in text"],
    faqs: [
  ...
  "spoken-english": {
    keywords: ["Spoken English tutor", "conversational English practice", "spoken English tutor near me", "1:1 spoken English tutoring", "English speaking practice online", "English accent reduction tutor online", "English fluency coach online", "spoken English tutor for adults", "spoken English tutor for ESL learners", "IELTS speaking practice tutor", "English speaking tutor for job interviews", "business English speaking coach", "spoken English tutor for beginners", "English pronunciation tutor online", "spoken English tutor for professionals", "English conversation practice for confidence", "spoken English classes for non-native speakers", "English speaking tutor for public speaking", "Indian tutor for Spoken English", "Spoken English Indian tutor", "Spoken English online Indian tutor", "Spoken English tutor from India", "online Spoken English tutor in India", "hire Indian tutor for Spoken English"],
    template: "standard",
    ...
    subjectDetailHighlights: ["pronunciation: sounds and sentence stress", "fluency: reducing hesitation and filler words", "listening at natural conversational speed", "building confidence to speak in real time"],
    faqs: [
  ...
  "o-level-chemistry": {
    ...
    subjectDetailHighlights: ["mole concept underlying stoichiometry", "atomic structure and ionic/covalent bonding", "reactivity series, acids and bases", "practical gas and ion identification tests"],
    faqs: [
  ...
  "o-level-maths": {
    ...
    subjectDetailHighlights: ["Elementary Math vs. Additional Math split", "E Math: algebra, geometry, trigonometry, stats", "A Math: pre-calculus, differentiation, integration", "translating word problems into equations"],
    faqs: [
  ...
  "o-level-physics": {
    ...
    subjectDetailHighlights: ["mechanics: motion, forces, mass vs. weight", "energy forms and conversions", "circuit diagrams and electricity concepts", "practical skills: vernier calipers, micrometers"],
    faqs: [
  ...
  "psle-maths": {
    keywords: ["PSLE Maths tutor", "PSLE Maths tutor Singapore", "PSLE Maths tuition", "1:1 PSLE Maths tutoring", "PSLE Maths tutor online", "PSLE Maths tuition online", "PSLE Maths tutor for expat families", "hire PSLE Maths tutor online", "best PSLE Maths tutor", "PSLE Maths tutor MOE syllabus", "private PSLE Maths tutor online", "PSLE Maths tutor reviews", "PSLE Maths tutor Primary 6", "live PSLE Maths tutor online", "PSLE Maths tutor problem sums", "Indian tutor for PSLE Maths", "PSLE Maths Indian tutor", "PSLE Maths online Indian tutor", "PSLE Maths tutor from India", "online PSLE Maths tutor in India", "hire Indian tutor for PSLE Maths"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["bar-modeling (model-drawing) method", "fractions, ratio, percentage, area and volume", "introduction to speed problems", "decomposing multi-step word problems"],
    faqs: [
  ...
  "psle-science": {
    ...
    subjectDetailHighlights: ["explaining observations with precise vocabulary", "themes: diversity, cycles, systems, interactions, energy", "human body systems: digestive, respiratory, circulatory", "diagram labeling and interpretation"],
    faqs: [
  ...
  "11-english": {
    ...
    subjectDetailHighlights: ["timed comprehension and inference questions", "vocabulary: synonyms, antonyms, cloze passages", "creative writing under time pressure", "CEM vs. GL Assessment paper formats"],
    faqs: [
  ...
  "11-maths": {
    ...
    subjectDetailHighlights: ["multi-step word problem structure", "fractions, decimals, percentages without a calculator", "mental arithmetic speed under time pressure", "non-verbal/spatial reasoning in some papers"],
    faqs: [
      { q: "What is the 11+ exam?", a: "A UK entrance exam used by grammar schools and some selective independent schools, typically taken around age 10-11." },
  ...
  "american-curriculum": {
    ...
    subjectDetailHighlights: ["continuity with US K-12 grade structure", "core subjects: ELA, math, science, social studies", "Common Core standards vary by state", "steady pacing vs. single high-stakes exam"],
    faqs: [
  ...
  "british-curriculum": {
    keywords: ["British Curriculum tutor", "British Curriculum tutor abroad", "expat British Curriculum tutoring", "1:1 British Curriculum tutoring", "British curriculum tutor for expat families", "British curriculum online school for expats", "British curriculum tutor overseas", "National Curriculum tutor for expat students", "Key Stage tutor for expat students", "British curriculum tutor Dubai", "British curriculum tutor Singapore", "British curriculum homeschool tutor abroad", "British curriculum tutor for international school", "GCSE tutor for expat students", "British curriculum tutor for returning students", "British curriculum gap tutor for expats", "British curriculum tutor for UK students abroad", "British curriculum tutoring for relocating families", "11 Plus tutor for expat families", "Indian tutor for British Curriculum", "British Curriculum Indian tutor", "British Curriculum online Indian tutor", "British Curriculum tutor from India", "online British Curriculum tutor in India", "hire Indian tutor for British Curriculum"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["Key Stage structure from KS1 to KS5", "progress tracking rather than one terminal exam", "British international schools' Cambridge/Edexcel links", "smoothing transitions between UK and abroad"],
    faqs: [
  ...
  "algorithms": {
    ...
    subjectDetailHighlights: ["Big-O notation and growth-rate comparison", "sorting: bubble sort vs. merge sort", "linear vs. binary search", "recursion, dynamic programming, graph traversal"],
    faqs: [
  ...
  "computer-science": {
    ...
    subjectDetailHighlights: ["survey of programming fundamentals", "binary data representation and architecture", "algorithms and data structures overview", "AP CS Principles vs. AP CS A scope"],
    faqs: [
  ...
  "data-structures": {
    ...
    subjectDetailHighlights: ["arrays vs. linked lists trade-offs", "stacks, queues, and binary search trees", "hash tables and collision handling", "tree traversal: in-order, pre-order, post-order"],
    faqs: [
  ...
  "web-development": {
    ...
    subjectDetailHighlights: ["HTML structure, CSS styling, JS behavior", "front-end vs. back-end distinction", "CSS box model: padding, border, margin", "responsive design with media queries"],
    faqs: [
  ...
  // ---------------------------------------------------------------------
  "coding-for-kids": {
    keywords: ["Coding for Kids tutor", "coding tutor for kids", "kids programming tutor", "learn to code kids", "1:1 coding tutor for kids", "online coding classes for kids", "coding camp for kids online", "best coding classes for kids", "live online coding classes for kids", "private coding tutor for kids", "coding lessons for kids ages 8-12", "one on one coding classes for kids", "kids coding classes near me", "coding for beginners kids online", "STEM coding classes for kids", "coding tutor for teens", "personalized coding lessons for children", "kids programming classes online", "coding camp for kids ages 8-12", "learn coding online for kids and teens", "Indian tutor for Coding for Kids", "Coding for Kids Indian tutor", "Coding for Kids online Indian tutor", "Coding for Kids tutor from India", "online Coding for Kids tutor in India", "hire Indian tutor for Coding for Kids"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["sequencing, loops, and conditionals basics", "debugging as a core transferable skill", "block-based vs. text-based tool fit by age", "choosing between Scratch and Python Basics"],
    faqs: [
  ...
  "scratch-programming": {
    ...
    subjectDetailHighlights: ["stage, sprites, and color-coded block palette", "motion, control, and variable blocks", "building games, stories, and animations", "sharing and remixing community projects"],
    faqs: [
  ...
  "python-basics": {
    keywords: ["Python Basics tutor for kids", "Python for kids tutor", "kids coding tutor", "learn Python basics for kids", "1:1 Python tutor for kids", "Python coding camp for kids", "Python classes for kids online", "Python summer camp for kids and teens", "beginner Python course for kids", "Python 101 for kids", "online Python tutoring for kids and teens", "private Python lessons for kids", "Python coding for kids ages 11-18", "live online Python classes for kids", "Python for teens coding class", "kids Python programming camp", "one on one Python tutor for kids", "Python coding lessons for beginners kids", "fun Python coding class for kids", "Python tutor for middle school students", "Indian tutor for Python Basics", "Python Basics Indian tutor", "Python Basics online Indian tutor", "Python Basics tutor from India", "online Python Basics tutor in India", "hire Indian tutor for Python Basics"],
    template: "standard",
    differentiation:
    ...
    subjectDetailHighlights: ["print statements and turtle graphics drawing", "variables, loops, and conditionals via mini-projects", "indentation as Python's syntax rule", "stays short of OOP and outside libraries"],
    faqs: [
  ...
  "science": {
    ...
    subjectDetailHighlights: ["biology, chemistry, and physics coverage", "hypothesis, fair tests, and controlled variables", "flexible, no fixed exam-board syllabus", "diagnostic first session to find gaps"],
    faqs: [
