...
export const subjectPageContent: Record<string, SubjectPageContent> = {
  ...
  "ap-physics-1": {
    ...
    differentiation:
      "AP Physics 1 is College Board's algebra-based introductory physics exam — no calculus required — covering mechanics, waves, and simple circuits. Since the 2014 exam restructuring, it's the exam most people mean today when they say \"AP Physics.\" A TutorA tutor for this subject is matched to you specifically, reviewed by our team before being approved to teach, and works with you live rather than through a fixed-cohort class. Pricing is shown before you book, and if a match isn't the right fit we'll rematch you at no extra cost.",
    faqs: [
      {
  ...
  "ap-physics-c": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "AP Physics C is split into two calculus-based exams — Mechanics, and Electricity & Magnetism — typically taken by students concurrently studying or who've already completed AP Calculus. Many engineering-focused college programs specifically prefer AP Physics C credit over AP Physics 1. Every tutor on TutorA who teaches this subject is reviewed by our team before being matched, sessions are live and 1:1 rather than pre-recorded, and pricing is shown up front so there's no guessing before you book.",
    faqs: [
      {
  ...
  "ap-chemistry": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "AP Chemistry is one of the more content-dense AP sciences, pairing quantitative problem-solving with lab-based free-response questions — many college STEM programs specifically look for a 4 or 5 for intro chemistry credit. Because the pace is fast, ongoing 1:1 support through the year tends to help more than a pre-exam cram. Every tutor teaching AP Chemistry on TutorA is reviewed by our team before being matched, works with you live, and shows pricing before you book — never a flat, invented number.",
    faqs: [
      {
  ...
  "gcse-chemistry": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "GCSEs are UK qualifications typically taken around ages 14–16 (Years 10–11), graded on the 9–1 scale — and GCSE Chemistry has its own dedicated tutor ecosystem, entirely separate from IGCSE and A-Level Chemistry. On TutorA, tutors teaching this subject are matched to you directly, reviewed by our team beforehand, and work with you live rather than through pre-recorded content. Pricing is shown before booking, and our guarantee covers a free rematch if your first tutor isn't the right fit.",
    faqs: [
      {
  ...
  "igcse-physics": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "IGCSE Physics is the internationally-administered equivalent of GCSE Physics, run by boards like Cambridge International and Edexcel International, and shows no meaningful overlap with either GCSE or A-Level Physics in practice — a genuinely distinct subject worth its own tutor. On TutorA, tutors for this subject are matched to you directly and reviewed by our team beforehand, working with you live rather than through pre-recorded content. Pricing is shown before booking, and our guarantee covers a free rematch if your first tutor isn't the right fit.",
    faqs: [
      {
  ...
  "a-level-physics": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "A-Level Physics is a two-year UK qualification (Years 12–13, ages 16–18) that shows zero overlap with either GCSE or IGCSE Physics — a genuinely standalone subject, not a harder version of the same page. Tutors teaching A-Level Physics on TutorA are reviewed by our team before being matched and work with you live and 1:1. Pricing is shown before you book, and our guarantee covers a free rematch if your first tutor isn't the right fit.",
    faqs: [
      {
  ...
  "ib-chemistry": {
    ...
    showGuaranteeLink: true,
    differentiation:
      "IB Chemistry is offered at Higher Level (HL) or Standard Level (SL), with an Internal Assessment (IA) component, and is commonly taken alongside IB Physics by the same students. Tutors teaching IB Chemistry on TutorA are reviewed by our team before being matched and work with you live rather than through fixed video content. Pricing is shown before you book, and our guarantee covers a free rematch if your first tutor isn't the right fit.",
    faqs: [
      {
        q: "HL or SL — does it matter?",
  ...
  "java": {
    template: "practical-mentor",
    differentiation:
      "Java has long-established free tutorials and self-paced tracks — fine for a first pass at syntax, but they can't debug the actual compiler error on your screen or explain why your class isn't behaving as expected. A TutorA Java tutor works through your real code with you in live 1:1 sessions, whether you're in a school course, working toward AP Computer Science A, or prepping for technical interviews. Every tutor is reviewed before being matched, and pricing is shown up front.",
    faqs: [
      {
  ...
  "genetics": {
    template: "standard",
    differentiation:
      "Homework-help aggregators like Tutor.com, Princeton Review, and UPchieve route you to whichever tutor happens to be online. A TutorA Genetics tutor is different — matched to you specifically, reviewed by our team before being approved, and working with you live rather than through a queue. This subject is positioned for All Levels, and pricing is shown up front before you request a session.",
    faqs: [
  ...
  "human-anatomy": {
    template: "standard",
    differentiation:
      "Human Anatomy tutoring on TutorA means live, 1:1 sessions with a tutor matched to you and reviewed by our team beforehand — not a routed queue like the larger homework-help platforms (Tutor.com, Princeton Review, UPchieve, Wyzant, Varsity Tutors), and not a fixed video curriculum either. This page is positioned for All Levels. Pricing is shown before you book, whether you need ongoing support or help with a specific unit.",
    faqs: [
  ...
  "physics": {
    template: "standard",
    differentiation:
      "Physics sits alongside a handful of large homework-help platforms — Tutor.com, Princeton Review, UPchieve, Wyzant — each of which gives Physics its own dedicated page rather than a shared listing. TutorA does the same, but goes further: instead of routing you to whoever's online, you're matched with a specific tutor reviewed by our team beforehand. Sessions are live and 1:1, positioned for Grades 9–12, and pricing is shown before you book rather than buried in a subscription.",
    faqs: [
  ...
  "mathematics": {
    template: "standard",
    differentiation:
      "Homework-help aggregators like Tutor.com, Princeton Review, and UPchieve route you to whichever tutor happens to be online. A TutorA Mathematics tutor is different — matched to you specifically, reviewed by our team before being approved, and working with you live rather than through a queue. This subject is positioned for All Levels, and pricing is shown up front before you request a session.",
    faqs: [
  ...
  "organic-chemistry": {
    template: "standard",
    differentiation:
      "Every major homework-help platform — Tutor.com, Princeton Review, UPchieve, Wyzant — gives Organic Chemistry its own dedicated page, and TutorA does too, with one real difference: you're matched to a specific, reviewed tutor rather than whoever's available when you log in. Sessions are live and 1:1, this page is positioned for All Levels, and pricing is shown before booking, never a flat invented rate.",
    faqs: [
  ...
  "chemistry": {
    template: "standard",
    differentiation:
      "Homework-help aggregators like Tutor.com, Princeton Review, and UPchieve route you to whichever tutor happens to be online. A TutorA Chemistry tutor is different — matched to you specifically, reviewed by our team before being approved, and working with you live rather than through a queue. This subject is positioned for Grades 9–12, and pricing is shown up front before you request a session.",
    faqs: [
  ...
  "advanced-algebra": {
    template: "standard",
    differentiation:
      "Advanced Algebra sits alongside a handful of large homework-help platforms — Tutor.com, Princeton Review, UPchieve, Wyzant — each of which gives Advanced Algebra its own dedicated page rather than a shared listing. TutorA does the same, but goes further: instead of routing you to whoever's online, you're matched with a specific tutor reviewed by our team beforehand. Sessions are live and 1:1, positioned for Grades 11-12, and pricing is shown before you book rather than buried in a subscription.",
    faqs: [
  ...
  "pre-algebra": {
    template: "standard",
    differentiation:
      "Every major homework-help platform — Tutor.com, Princeton Review, UPchieve, Wyzant — gives Pre-Algebra its own dedicated page, and TutorA does too, with one real difference: you're matched to a specific, reviewed tutor rather than whoever's available when you log in. Sessions are live and 1:1, this page is positioned for Grades 6-8, and pricing is shown before booking, never a flat invented rate.",
    faqs: [
  ...
  "precalculus": {
    template: "standard",
    differentiation:
      "Homework-help aggregators like Tutor.com, Princeton Review, and UPchieve route you to whichever tutor happens to be online. A TutorA Precalculus tutor is different — matched to you specifically, reviewed by our team before being approved, and working with you live rather than through a queue. This subject is positioned for Grades 9-11, and pricing is shown up front before you request a session.",
    faqs: [
  ...
  "statistics": {
    template: "standard",
    differentiation:
      "Statistics tutoring on TutorA means live, 1:1 sessions with a tutor matched to you and reviewed by our team beforehand — not a routed queue like the larger homework-help platforms (Tutor.com, Princeton Review, UPchieve, Wyzant, Varsity Tutors), and not a fixed video curriculum either. This page is positioned for Grades 9-12. Pricing is shown before you book, whether you need ongoing support or help with a specific unit.",
    faqs: [
  ...
  "environmental-science": {
    template: "standard",
    differentiation:
      "Every major homework-help platform — Tutor.com, Princeton Review, UPchieve, Wyzant — gives Environmental Science its own dedicated page, and TutorA does too, with one real difference: you're matched to a specific, reviewed tutor rather than whoever's available when you log in. Sessions are live and 1:1, this page is positioned for Grades 9-10, and pricing is shown before booking, never a flat invented rate.",
    faqs: [
  ...
  "chemistry-basics": {
    template: "standard",
    differentiation:
      "For Grades 6-8 students, Chemistry Basics tutoring on TutorA focuses on building real confidence with the fundamentals, not just fixing a specific grade — a different emphasis than our exam-driven high-school subject pages. Every tutor is reviewed by our team before being matched, sessions are live and 1:1, and pricing is shown up front.",
    faqs: [
  ...
  "general-mathematics": {
    template: "standard",
    differentiation:
      "For Grades 6-8 students, General Mathematics tutoring on TutorA focuses on building real confidence with the fundamentals, not just fixing a specific grade — a different emphasis than our exam-driven high-school subject pages. Every tutor is reviewed by our team before being matched, sessions are live and 1:1, and pricing is shown up front.",
    faqs: [
  ...
  "geometry-basics": {
    template: "standard",
    differentiation:
      "For Grades 6-8 students, Geometry Basics tutoring on TutorA focuses on building real confidence with the fundamentals, not just fixing a specific grade — a different emphasis than our exam-driven high-school subject pages. Every tutor is reviewed by our team before being matched, sessions are live and 1:1, and pricing is shown up front.",
    faqs: [
  ...
  "psle-maths": {
    template: "standard",
    differentiation:
      "PSLE Maths tutoring on TutorA is positioned for Grade 6, aligned to Singapore's PSLE (Primary School Leaving Examination) — the national exam used for secondary school placement. Every tutor is reviewed by our team before being matched, sessions are live and 1:1, and pricing is shown before you book.",
    faqs: [
  ...
  "psle-science": {
    template: "standard",
    differentiation:
      "PSLE Science tutoring on TutorA is positioned for Grade 6, aligned to Singapore's PSLE (Primary School Leaving Examination) — the national exam used for secondary school placement. Every tutor is reviewed by our team before being matched, sessions are live and 1:1, and pricing is shown before you book.",
    faqs: [
  ...
  "algorithms": {
    template: "standard",
    differentiation:
      "Algorithms tutoring on TutorA means live 1:1 feedback on your specific project or assignment — a real differentiator from free tutorials and self-paced coding bootcamps, not a claim of better content. Every tutor is reviewed by our team before being matched, and pricing is shown before you book.",
    faqs: [
  ...
  "computer-science": {
    template: "standard",
    differentiation:
      "Computer Science tutoring on TutorA matches you with a specific, reviewed tutor rather than routing you to whoever's available — unlike large CS-focused aggregators such as Wyzant, Princeton Review, or Varsity Tutors. Sessions are live and 1:1, and pricing is shown before you book.",
    faqs: [
  ...
  "data-structures": {
    template: "standard",
    differentiation:
      "Data Structures tutoring on TutorA means live 1:1 feedback on your specific project or assignment — a real differentiator from free tutorials and self-paced coding bootcamps, not a claim of better content. Every tutor is reviewed by our team before being matched, and pricing is shown before you book.",
    faqs: [
  ...
  "web-development": {
    template: "standard",
    differentiation:
      "Web Development tutoring on TutorA means live 1:1 feedback on your specific project or assignment — a real differentiator from free tutorials and self-paced coding bootcamps, not a claim of better content. Every tutor is reviewed by our team before being matched, and pricing is shown before you book.",
    faqs: [
  ...
  "coding-for-kids": {
    template: "standard",
    differentiation:
      "Coding for Kids on TutorA is a broad entry point for parents who aren't sure which specific tool is right yet for their child — a matched tutor can help decide between Scratch, Python Basics, or another approach based on age and interest. TutorA reviews tutors before they're matched, the same review process used sitewide — sessions are live and 1:1, positioned for Grades 6-8.",
    faqs: [
  ...
  "scratch-programming": {
    template: "standard",
    differentiation:
      "Scratch is a free, block-based visual programming language created by MIT specifically for kids — no typed code required, making it a common first step before text-based languages like Python. TutorA reviews tutors before they're matched, the same process used sitewide, and sessions are live and 1:1, positioned for Grades 6-8. Pricing is shown before you book.",
    faqs: [
  ...
  "python-basics": {
    template: "standard",
    differentiation:
      "Python Basics for kids on TutorA means age-appropriate, hands-on projects — small games, simple automation scripts — rather than abstract syntax drills, distinct from our general Python page, which serves an adult and teen audience with different trust signals. TutorA reviews tutors before they're matched, the same process used sitewide, and sessions are live and 1:1, positioned for Grades 6-8.",
    faqs: [
