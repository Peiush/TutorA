...
export interface CourseSubjectContent {
  ...
  courseDetail?: string;
  /** 3-4 short scannable bullets summarizing courseDetail, shown above it while the full
   *  prose is collapsed — see components/courses/expandable-detail.tsx. */
  courseDetailHighlights?: string[];
}
...
export const courseSubjectContent: Record<string, CourseSubjectContent> = {
  ...
  // ---------------------------------------------------------------------
  "python-ff654450": {
    keywords: ["Python Programming for Beginners tutor", "Python Programming for Beginners classes online", "Python Programming for Beginners tutor near me", "private Python Programming for Beginners tutor", "best Python Programming for Beginners tutor", "1:1 Python Programming for Beginners tutoring", "Python Programming for Beginners course for beginners", "learn Python Programming for Beginners", "how to learn Python Programming for Beginners", "is Python Programming for Beginners hard to learn", "Python Programming for Beginners for kids", "Indian tutor for Python Programming for Beginners", "Python Programming for Beginners Indian tutor", "Python Programming for Beginners online Indian tutor", "Python Programming for Beginners tutor from India", "online Python Programming for Beginners tutor in India", "hire Indian tutor for Python Programming for Beginners"],
    differentiation:
    ...
    courseDetailHighlights: ["indentation is syntax, not style", "core progression: variables, loops, functions, OOP", "mutable default argument gotchas", "ecosystem spans automation, Django/Flask, pandas/NumPy"],
    faqs: [
      {
  ...
  "javascript-ac5adb0a": {
    ...
    courseDetailHighlights: ["event loop: non-blocking despite single-threaded", "async/await, promises, callbacks for async code", "== vs === and type coercion surprises", "DOM selection, event handling, then frameworks like React"],
    faqs: [
      {
  ...
  "sql-90d171c1": {
    keywords: ["SQL for Beginners tutor", "SQL for Beginners classes online", "SQL for Beginners tutor near me", "private SQL for Beginners tutor", "best SQL for Beginners tutor", "1:1 SQL for Beginners tutoring", "SQL for Beginners course for beginners", "learn SQL for Beginners", "how to learn SQL for Beginners", "is SQL for Beginners hard to learn", "SQL for Beginners for kids", "Indian tutor for SQL for Beginners", "SQL for Beginners Indian tutor", "SQL for Beginners online Indian tutor", "SQL for Beginners tutor from India", "online SQL for Beginners tutor in India", "hire Indian tutor for SQL for Beginners"],
    differentiation:
    ...
    courseDetailHighlights: ["core commands: SELECT, WHERE, GROUP BY, JOIN", "INNER JOIN vs. LEFT JOIN behavior", "aggregate functions (COUNT, SUM, AVG) with GROUP BY", "reading query plans via EXPLAIN"],
    faqs: [
      {
  ...
  "java-48483b48": {
    ...
    courseDetailHighlights: ["static typing enforced at compile time", "OOP core: classes, objects, inheritance, interfaces", "checked exceptions and try/catch handling", "== vs. .equals() for object comparison"],
    faqs: [
      {
  ...
  "c-95361960": {
    keywords: ["C++ Programming for Beginners tutor", "C++ Programming for Beginners classes online", "C++ Programming for Beginners tutor near me", "private C++ Programming for Beginners tutor", "best C++ Programming for Beginners tutor", "1:1 C++ Programming for Beginners tutoring", "C++ Programming for Beginners course for beginners", "learn C++ Programming for Beginners", "how to learn C++ Programming for Beginners", "is C++ Programming for Beginners hard to learn", "C++ Programming for Beginners for kids", "Indian tutor for C++ Programming for Beginners", "C++ Programming for Beginners Indian tutor", "C++ Programming for Beginners online Indian tutor", "C++ Programming for Beginners tutor from India", "online C++ Programming for Beginners tutor in India", "hire Indian tutor for C++ Programming for Beginners"],
    differentiation:
    ...
    courseDetailHighlights: ["manual memory management: new/delete, leaks", "pointers vs. references vs. values", "templates and STL containers like vector, map", "used in game engines, embedded systems, trading infra"],
    faqs: [
      {
  ...
  "html-css-fb9cd7a2": {
    keywords: ["HTML & CSS tutor", "HTML & CSS classes online", "HTML & CSS tutor near me", "private HTML & CSS tutor", "best HTML & CSS tutor", "1:1 HTML & CSS tutoring", "HTML & CSS course for beginners", "learn HTML & CSS", "how to learn HTML & CSS", "is HTML & CSS hard to learn", "HTML & CSS for kids", "Indian tutor for HTML & CSS", "HTML & CSS Indian tutor", "HTML & CSS online Indian tutor", "HTML & CSS tutor from India", "online HTML & CSS tutor in India", "hire Indian tutor for HTML & CSS"],
    differentiation:
    ...
    courseDetailHighlights: ["HTML structure vs. CSS appearance/layout", "cascade: specificity and source order", "box model: content, padding, border, margin", "flexbox (1D) vs. grid (2D) layouts"],
    faqs: [
      {
  ...
  "computer-science-758eff7f": {
    keywords: ["Computer Science tutor", "Computer Science classes online", "Computer Science tutor near me", "private Computer Science tutor", "best Computer Science tutor", "1:1 Computer Science tutoring", "Computer Science course for beginners", "learn Computer Science", "how to learn Computer Science", "is Computer Science hard to learn", "Computer Science for kids", "Indian tutor for Computer Science", "Computer Science Indian tutor", "Computer Science online Indian tutor", "Computer Science tutor from India", "online Computer Science tutor in India", "hire Indian tutor for Computer Science"],
    differentiation:
    ...
    courseDetailHighlights: ["arrays, linked lists, stacks, queues fundamentals", "Big O notation: reasoning about growth rates", "trees, graphs, hash tables, recursion", "branches into OS, databases, computer architecture"],
    faqs: [
      {
  ...
  "data-science-6209e272": {
    keywords: ["Data Science tutor", "Data Science classes online", "Data Science tutor near me", "private Data Science tutor", "best Data Science tutor", "1:1 Data Science tutoring", "Data Science course for beginners", "learn Data Science", "how to learn Data Science", "is Data Science hard to learn", "Data Science for kids", "Indian tutor for Data Science", "Data Science Indian tutor", "Data Science online Indian tutor", "Data Science tutor from India", "online Data Science tutor in India", "hire Indian tutor for Data Science"],
    differentiation:
    ...
    courseDetailHighlights: ["exploratory data analysis: missing values, outliers", "statistics: correlation vs. causation, p-values", "model evaluation: precision, recall, cross-validation", "choosing the right chart for the data"],
    faqs: [
      {
  ...
  "ai-machine-learning-advanced-e4eabe28": {
    keywords: ["AI & Machine Learning (Advanced) tutor", "AI & Machine Learning (Advanced) classes online", "AI & Machine Learning (Advanced) tutor near me", "private AI & Machine Learning (Advanced) tutor", "best AI & Machine Learning (Advanced) tutor", "1:1 AI & Machine Learning (Advanced) tutoring", "AI & Machine Learning (Advanced) course for beginners", "learn AI & Machine Learning (Advanced)", "how to learn AI & Machine Learning (Advanced)", "is AI & Machine Learning (Advanced) hard to learn", "AI & Machine Learning (Advanced) for kids", "Indian tutor for AI & Machine Learning (Advanced)", "AI & Machine Learning (Advanced) Indian tutor", "AI & Machine Learning (Advanced) online Indian tutor", "AI & Machine Learning (Advanced) tutor from India", "online AI & Machine Learning (Advanced) tutor in India", "hire Indian tutor for AI & Machine Learning (Advanced)"],
    differentiation:
    ...
    courseDetailHighlights: ["overfitting: training vs. validation performance gap", "regularization, dropout, train/val/test splits", "hyperparameter tuning: learning rate, batch size, depth", "reading loss curves and attention-based architectures"],
    faqs: [
      {
  ...
  "ai-for-beginners-0939362a": {
    keywords: ["AI for Beginners tutor", "AI for Beginners classes online", "AI for Beginners tutor near me", "private AI for Beginners tutor", "best AI for Beginners tutor", "1:1 AI for Beginners tutoring", "AI for Beginners course for beginners", "learn AI for Beginners", "how to learn AI for Beginners", "is AI for Beginners hard to learn", "AI for Beginners for kids", "Indian tutor for AI for Beginners", "AI for Beginners Indian tutor", "AI for Beginners online Indian tutor", "AI for Beginners tutor from India", "online AI for Beginners tutor in India", "hire Indian tutor for AI for Beginners"],
    differentiation:
    ...
    courseDetailHighlights: ["AI vs. machine learning vs. deep learning defined", "supervised vs. unsupervised learning", "what 'training' a model actually means", "grounded in recommendation systems, spam filters, voice assistants"],
    faqs: [
      {
  ...
  "react-for-beginners-327c29e1": {
    ...
    courseDetailHighlights: ["components as a tree of reusable UI", "JSX quirks: className, fragments, curly braces", "props (parent to child) vs. state (own data)", "useState, useEffect, and stable list keys"],
    faqs: [
      {
  ...
  "scratch-programming-for-kids-7fa6fba9": {
    ...
    courseDetailHighlights: ["color-coded blocks: motion, looks, sound, control", "loops, conditionals, variables, events", "sequencing: blocks run in stacked order", "builds toward a finished, shareable project"],
    faqs: [
      {
  ...
  "robotics-for-kids-3b988a24": {
    keywords: ["Robotics for Kids tutor", "Robotics for Kids classes online", "Robotics for Kids tutor near me", "private Robotics for Kids tutor", "best Robotics for Kids tutor", "1:1 Robotics for Kids tutoring", "Robotics for Kids course for beginners", "learn Robotics for Kids", "how to learn Robotics for Kids", "is Robotics for Kids hard to learn", "Robotics for Kids for kids", "Indian tutor for Robotics for Kids", "Robotics for Kids Indian tutor", "Robotics for Kids online Indian tutor", "Robotics for Kids tutor from India", "online Robotics for Kids tutor in India", "hire Indian tutor for Robotics for Kids"],
    differentiation:
    ...
    courseDetailHighlights: ["mechanical build: motors, wheels, sensors", "block-based or simplified text programming", "sensor-driven behavior, e.g. line-following", "debugging is visible and immediate in a real robot"],
    faqs: [
      {
  ...
  // ---------------------------------------------------------------------
  "spanish-2dd27e6e": {
    keywords: ["Spanish tutor", "Spanish classes online", "Spanish tutor near me", "private Spanish tutor", "best Spanish tutor", "1:1 Spanish tutoring", "Spanish course for beginners", "learn Spanish", "how to learn Spanish", "is Spanish hard to learn", "Spanish for kids", "Indian tutor for Spanish", "Spanish Indian tutor", "Spanish online Indian tutor", "Spanish tutor from India", "online Spanish tutor in India", "hire Indian tutor for Spanish"],
    differentiation:
    ...
    courseDetailHighlights: ["ser vs. estar distinction", "subjunctive mood: quiero que, ojalá, es importante que", "preterite vs. imperfect past tense split", "dialect differences: Mexican, Argentine, Castilian"],
    faqs: [
      {
  ...
  "french-520eb7f0": {
    keywords: ["French tutor", "French classes online", "French tutor near me", "private French tutor", "best French tutor", "1:1 French tutoring", "French course for beginners", "learn French", "how to learn French", "is French hard to learn", "French for kids", "Indian tutor for French", "French Indian tutor", "French online Indian tutor", "French tutor from India", "online French tutor in India", "hire Indian tutor for French"],
    differentiation:
    ...
    courseDetailHighlights: ["liaison rules and silent written consonants", "nasal vowels: vin, vent, vont distinctions", "passé composé vs. imparfait for the past", "tu vs. vous formality distinction"],
    faqs: [
      {
  ...
  "german-a83fb505": {
    keywords: ["German tutor", "German classes online", "German tutor near me", "private German tutor", "best German tutor", "1:1 German tutoring", "German course for beginners", "learn German", "how to learn German", "is German hard to learn", "German for kids", "Indian tutor for German", "German Indian tutor", "German online Indian tutor", "German tutor from India", "online German tutor in India", "hire Indian tutor for German"],
    differentiation:
    ...
    courseDetailHighlights: ["case system: nominative, accusative, dative, genitive", "verb-second order, verb-final in subordinate clauses", "separable-prefix verbs like anrufen", "compound nouns built by stringing words together"],
    faqs: [
      {
  ...
  "italian-0bce3f0c": {
    keywords: ["Italian tutor", "Italian classes online", "Italian tutor near me", "private Italian tutor", "best Italian tutor", "1:1 Italian tutoring", "Italian course for beginners", "learn Italian", "how to learn Italian", "is Italian hard to learn", "Italian for kids", "Indian tutor for Italian", "Italian Indian tutor", "Italian online Indian tutor", "Italian tutor from India", "online Italian tutor in India", "hire Indian tutor for Italian"],
    differentiation:
    ...
    courseDetailHighlights: ["irregular present-tense verbs: essere, avere, andare", "passato prossimo vs. imperfetto for the past", "noun-gender agreement across a sentence", "double-consonant pronunciation: nonno vs. nono"],
    faqs: [
      {
  ...
  "portuguese-4702233f": {
    keywords: ["Portuguese tutor", "Portuguese classes online", "Portuguese tutor near me", "private Portuguese tutor", "best Portuguese tutor", "1:1 Portuguese tutoring", "Portuguese course for beginners", "learn Portuguese", "how to learn Portuguese", "is Portuguese hard to learn", "Portuguese for kids", "Indian tutor for Portuguese", "Portuguese Indian tutor", "Portuguese online Indian tutor", "Portuguese tutor from India", "online Portuguese tutor in India", "hire Indian tutor for Portuguese"],
    differentiation:
    ...
    courseDetailHighlights: ["Brazilian vs. European vocabulary and pronunciation", "heavy verb conjugation, incl. personal infinitive", "nasal vowels and diphthongs: São, mãe", "subjunctive mood in everyday speech"],
    faqs: [
      {
  ...
  "russian-7692b797": {
    keywords: ["Russian tutor", "Russian classes online", "Russian tutor near me", "private Russian tutor", "best Russian tutor", "1:1 Russian tutoring", "Russian course for beginners", "learn Russian", "how to learn Russian", "is Russian hard to learn", "Russian for kids", "Indian tutor for Russian", "Russian Indian tutor", "Russian online Indian tutor", "Russian tutor from India", "online Russian tutor in India", "hire Indian tutor for Russian"],
    differentiation:
    ...
    courseDetailHighlights: ["six-case noun system changes word endings", "verbal aspect: perfective vs. imperfective", "Cyrillic alphabet, soft vs. hard consonants", "stress-based shifts in vowel pronunciation"],
    faqs: [
      {
  ...
  "chinese-mandarin-81d5f035": {
    ...
    courseDetailHighlights: ["four tones plus neutral tone (mā, má, mǎ, mà)", "tone sandhi in connected speech", "pinyin and radicals before full characters", "simplified vs. traditional character systems"],
    faqs: [
      {
  ...
  "japanese-34b5d228": {
    keywords: ["Japanese tutor", "Japanese classes online", "Japanese tutor near me", "private Japanese tutor", "best Japanese tutor", "1:1 Japanese tutoring", "Japanese course for beginners", "learn Japanese", "how to learn Japanese", "is Japanese hard to learn", "Japanese for kids", "Indian tutor for Japanese", "Japanese Indian tutor", "Japanese online Indian tutor", "Japanese tutor from India", "online Japanese tutor in India", "hire Indian tutor for Japanese"],
    differentiation:
    ...
    courseDetailHighlights: ["hiragana, katakana, and kanji each handle different roles", "subject-object-verb sentence order", "politeness levels: casual, -masu/-desu, keigo", "kanji readings shift depending on context"],
    faqs: [
      {
  ...
  "korean-3be8ff00": {
    keywords: ["Korean tutor", "Korean classes online", "Korean tutor near me", "private Korean tutor", "best Korean tutor", "1:1 Korean tutoring", "Korean course for beginners", "learn Korean", "how to learn Korean", "is Korean hard to learn", "Korean for kids", "Indian tutor for Korean", "Korean Indian tutor", "Korean online Indian tutor", "Korean tutor from India", "online Korean tutor in India", "hire Indian tutor for Korean"],
    differentiation:
    ...
    courseDetailHighlights: ["Hangul: deliberately designed, quick to read", "particles mark grammatical role, not word order", "speech levels: formal, polite, casual endings", "Sino-Korean vs. native Korean vocabulary roots"],
    faqs: [
      {
  ...
  "arabic-bee72fa4": {
    keywords: ["Arabic tutor", "Arabic classes online", "Arabic tutor near me", "private Arabic tutor", "best Arabic tutor", "1:1 Arabic tutoring", "Arabic course for beginners", "learn Arabic", "how to learn Arabic", "is Arabic hard to learn", "Arabic for kids", "Indian tutor for Arabic", "Arabic Indian tutor", "Arabic online Indian tutor", "Arabic tutor from India", "online Arabic tutor in India", "hire Indian tutor for Arabic"],
    differentiation:
    ...
    courseDetailHighlights: ["right-to-left script, position-dependent letter shapes", "root-and-pattern system, e.g. k-t-b", "Modern Standard Arabic vs. regional dialects", "sounds with no English equivalent: ح, ع"],
    faqs: [
      {
  ...
  "hindi-language-course-459bc4ba": {
    keywords: ["Hindi tutor", "Hindi classes online", "Hindi tutor near me", "private Hindi tutor", "best Hindi tutor", "1:1 Hindi tutoring", "Hindi course for beginners", "learn Hindi", "how to learn Hindi", "is Hindi hard to learn", "Hindi for kids", "Indian tutor for Hindi", "Hindi Indian tutor", "Hindi online Indian tutor", "Hindi tutor from India", "online Hindi tutor in India", "hire Indian tutor for Hindi"],
    differentiation:
    ...
    courseDetailHighlights: ["heritage learners vs. complete-beginner paths differ", "verb and adjective gender agreement, incl. past tense", "Devanagari script and conjunct consonants", "everyday Hindi code-switches heavily with English"],
    faqs: [
      {
  ...
  "sanskrit-5eea98ab": {
    keywords: ["Sanskrit tutor", "Sanskrit classes online", "Sanskrit tutor near me", "private Sanskrit tutor", "best Sanskrit tutor", "1:1 Sanskrit tutoring", "Sanskrit course for beginners", "learn Sanskrit", "how to learn Sanskrit", "is Sanskrit hard to learn", "Sanskrit for kids", "Indian tutor for Sanskrit", "Sanskrit Indian tutor", "Sanskrit online Indian tutor", "Sanskrit tutor from India", "online Sanskrit tutor in India", "hire Indian tutor for Sanskrit"],
    differentiation:
    ...
    courseDetailHighlights: ["read for texts: Vedas, Upanishads, epics", "Panini's systematic grammar codification", "sandhi rules at word and syllable boundaries", "Devanagari script and noun/verb forms first"],
    faqs: [
      {
  ...
  "spoken-english-course-5dbc4867": {
    keywords: ["Spoken English tutor", "Spoken English classes online", "Spoken English tutor near me", "private Spoken English tutor", "best Spoken English tutor", "1:1 Spoken English tutoring", "Spoken English course for beginners", "learn Spoken English", "how to learn Spoken English", "is Spoken English hard to learn", "Spoken English for kids", "Indian tutor for Spoken English", "Spoken English Indian tutor", "Spoken English online Indian tutor", "Spoken English tutor from India", "online Spoken English tutor in India", "hire Indian tutor for Spoken English"],
    differentiation:
    ...
    courseDetailHighlights: ["fluency and confidence over grammatical accuracy", "reducing hesitation and filler words", "practicing real contexts: interviews, meetings, small talk", "listening comprehension of fast, informal speech"],
    faqs: [
      {
  ...
  "business-english-course-e6a73822": {
    ...
    courseDetailHighlights: ["email tone: polite, not overly formal", "negotiation phrasing that hedges direct statements", "presentation structure: front-load the key point", "meeting skills: interrupting and disagreeing politely"],
    faqs: [
      {
  ...
  "adobe-photoshop-394813c4": {
    ...
    courseDetailHighlights: ["selection tools: lasso, magic wand, AI object selection", "layers and layer masks fundamentals", "non-destructive editing via adjustment layers, smart objects", "specialization tracks: retouching, compositing, digital painting"],
    faqs: [
      {
  ...
  "adobe-illustrator-51e96821": {
    ...
    courseDetailHighlights: ["Pen tool mastery: anchor points and handles", "Pathfinder panel, compound paths, Shape Builder tool", "vector vs. raster scaling differences", "print file prep: closed paths, color modes"],
    faqs: [
      {
  ...
  "graphic-design-a6240a94": {
    keywords: ["Graphic Design tutor", "Graphic Design classes online", "Graphic Design tutor near me", "private Graphic Design tutor", "best Graphic Design tutor", "1:1 Graphic Design tutoring", "Graphic Design course for beginners", "learn Graphic Design", "how to learn Graphic Design", "is Graphic Design hard to learn", "Graphic Design for kids", "Indian tutor for Graphic Design", "Graphic Design Indian tutor", "Graphic Design online Indian tutor", "Graphic Design tutor from India", "online Graphic Design tutor in India", "hire Indian tutor for Graphic Design"],
    differentiation:
    ...
    courseDetailHighlights: ["design process: research, sketching, concept narrowing", "typography: typeface pairing and hierarchy", "grid systems and consistent spacing", "color theory across print, screen, signage"],
    faqs: [
      {
  ...
  "ui-ux-design-85bad5a6": {
    keywords: ["UI/UX Design tutor", "UI/UX Design classes online", "UI/UX Design tutor near me", "private UI/UX Design tutor", "best UI/UX Design tutor", "1:1 UI/UX Design tutoring", "UI/UX Design course for beginners", "learn UI/UX Design", "how to learn UI/UX Design", "is UI/UX Design hard to learn", "UI/UX Design for kids", "Indian tutor for UI/UX Design", "UI/UX Design Indian tutor", "UI/UX Design online Indian tutor", "UI/UX Design tutor from India", "online UI/UX Design tutor in India", "hire Indian tutor for UI/UX Design"],
    differentiation:
    ...
    courseDetailHighlights: ["information architecture and low-fi wireframing", "Figma components, variants, auto-layout, design systems", "prototyping clickable flows for review", "usability testing and feedback interpretation"],
    faqs: [
      {
  ...
  "video-editing-55a060cd": {
    keywords: ["Video Editing tutor", "Video Editing classes online", "Video Editing tutor near me", "private Video Editing tutor", "best Video Editing tutor", "1:1 Video Editing tutoring", "Video Editing course for beginners", "learn Video Editing", "how to learn Video Editing", "is Video Editing hard to learn", "Video Editing for kids", "Indian tutor for Video Editing", "Video Editing Indian tutor", "Video Editing online Indian tutor", "Video Editing tutor from India", "online Video Editing tutor in India", "hire Indian tutor for Video Editing"],
    differentiation:
    ...
    courseDetailHighlights: ["pacing and cut timing", "color correction vs. color grading", "J-cuts and L-cuts for transitions", "export settings: resolution, frame rate, codec"],
    faqs: [
      {
  ...
  // ---------------------------------------------------------------------
  "guitar-a7d7f6aa": {
    keywords: ["Guitar tutor", "Guitar lessons online", "Guitar tutor near me", "private Guitar tutor", "best Guitar tutor", "1:1 Guitar tutoring", "Guitar classes online", "Guitar course for beginners", "learn Guitar", "how to learn Guitar", "is Guitar hard to learn", "Guitar for kids", "Indian tutor for Guitar", "Guitar Indian tutor", "Guitar online Indian tutor", "Guitar tutor from India", "online Guitar tutor in India", "hire Indian tutor for Guitar"],
    differentiation:
    ...
    courseDetailHighlights: ["barre chords and the F chord hurdle", "CAGED system and scale shapes for lead playing", "fingerstyle: independent thumb-finger coordination", "standard notation vs. tab and chord charts"],
    faqs: [
      {
  ...
  "piano-02656f00": {
    keywords: ["Piano tutor", "Piano lessons online", "Piano tutor near me", "private Piano tutor", "best Piano tutor", "1:1 Piano tutoring", "Piano classes online", "Piano course for beginners", "learn Piano", "how to learn Piano", "is Piano hard to learn", "Piano for kids", "Indian tutor for Piano", "Piano Indian tutor", "Piano online Indian tutor", "Piano tutor from India", "online Piano tutor in India", "hire Indian tutor for Piano"],
    differentiation:
    ...
    courseDetailHighlights: ["hand independence: different rhythm per hand", "Hanon and Czerny technique exercises", "sight-reading as a distinct skill", "pedaling judgment and musical phrasing"],
    faqs: [
      {
  ...
  "violin-c7b9774e": {
    keywords: ["Violin tutor", "Violin lessons online", "Violin tutor near me", "private Violin tutor", "best Violin tutor", "1:1 Violin tutoring", "Violin classes online", "Violin course for beginners", "learn Violin", "how to learn Violin", "is Violin hard to learn", "Violin for kids", "Indian tutor for Violin", "Violin Indian tutor", "Violin online Indian tutor", "Violin tutor from India", "online Violin tutor in India", "hire Indian tutor for Violin"],
    differentiation:
    ...
    courseDetailHighlights: ["first position through shifting to third", "vibrato development and control", "bow strokes: détaché, staccato, spiccato", "scales and etudes to isolate weaknesses"],
    faqs: [
      {
  ...
  "singing-2d883ea7": {
    keywords: ["Singing tutor", "Singing lessons online", "Singing tutor near me", "private Singing tutor", "best Singing tutor", "1:1 Singing tutoring", "Singing classes online", "Singing course for beginners", "learn Singing", "how to learn Singing", "is Singing hard to learn", "Singing for kids", "Indian tutor for Singing", "Singing Indian tutor", "Singing online Indian tutor", "Singing tutor from India", "online Singing tutor in India", "hire Indian tutor for Singing"],
    differentiation:
    ...
    courseDetailHighlights: ["breath support and posture fundamentals", "chest voice, head voice, and the passaggio", "genre-specific technique: theater, pop, classical, jazz", "ear training for pitch accuracy"],
    faqs: [
      {
  ...
  "music-theory-88e94e5a": {
    keywords: ["Music Theory tutor", "Music Theory lessons online", "Music Theory tutor near me", "private Music Theory tutor", "best Music Theory tutor", "1:1 Music Theory tutoring", "Music Theory classes online", "Music Theory course for beginners", "learn Music Theory", "how to learn Music Theory", "is Music Theory hard to learn", "Music Theory for kids", "Indian tutor for Music Theory", "Music Theory Indian tutor", "Music Theory online Indian tutor", "Music Theory tutor from India", "online Music Theory tutor in India", "hire Indian tutor for Music Theory"],
    differentiation:
    ...
    courseDetailHighlights: ["intervals, scales, and chord construction basics", "harmony and voice leading judgment", "ear training: identifying intervals and chords by ear", "ABRSM theory grades: figured bass, four-part harmony"],
    faqs: [
      {
  ...
  "dance-8f1859ae": {
    keywords: ["Dance tutor", "Dance lessons online", "Dance tutor near me", "private Dance tutor", "best Dance tutor", "1:1 Dance tutoring", "Dance classes online", "Dance course for beginners", "learn Dance", "how to learn Dance", "is Dance hard to learn", "Dance for kids", "Indian tutor for Dance", "Dance Indian tutor", "Dance online Indian tutor", "Dance tutor from India", "online Dance tutor in India", "hire Indian tutor for Dance"],
    differentiation:
    ...
    courseDetailHighlights: ["style-specific warm-ups: ballet vs. hip-hop", "isolated technique: body rolls, footwork patterns", "musicality: timing and accent on the beat", "building toward a full combination or routine"],
    faqs: [
      {
  ...
  "sat-c5d2749b": {
    ...
    courseDetailHighlights: ["module-adaptive format sets second-module difficulty", "Reading and Writing: short, single-passage questions", "Math: calculator allowed, tight per-question timing", "superscoring across multiple test sittings"],
    faqs: [
  ...
  "act-dccdc694": {
    ...
    courseDetailHighlights: ["Science section tests data interpretation, not content", "Math includes trigonometry-level content", "English tests grammar and rhetorical skill", "optional Writing section, scored separately"],
    faqs: [
  ...
  "psat-preparation-course-4b552b9e": {
    ...
    courseDetailHighlights: ["National Merit qualification in eleventh grade", "1520-point scale plus separate Selection Index", "taken in October, mirrors digital SAT format", "tenth grade use: diagnostic before the SAT"],
    faqs: [
  ...
  "gre-a2b8cace": {
    ...
    courseDetailHighlights: ["Verbal: text completion and sentence equivalence", "Quant: quantitative comparison reasoning", "Analytical Writing scored on separate scale", "ScoreSelect: choosing which test date to send"],
    faqs: [
  ...
  "gmat-d7e5eb9d": {
    ...
    courseDetailHighlights: ["Focus Edition: three sections, 205-805 total", "Data Insights: data sufficiency, graphics interpretation", "Quant: mostly no calculator, reasoning-focused", "question-level adaptive with bookmark/revisit option"],
    faqs: [
  ...
  "toefl-3a2e48ed": {
    ...
    courseDetailHighlights: ["integrated tasks: read, listen, then synthesize", "note-taking technique across multiple sections", "independent tasks scored on structure, language use", "scored 0-30 per section, 120 total"],
    faqs: [
  ...
  "ielts-8d4686db": {
    ...
    courseDetailHighlights: ["Listening and Reading: 40-question format, trap patterns", "Writing Task 1 report/letter, Task 2 essay", "Speaking: 11-14 minute live interview", "Academic vs. General Training differences"],
    faqs: [
  ...
  "pte-302557b2": {
    ...
    courseDetailHighlights: ["automated AI scoring rewards steady pacing", "integrated tasks: Read Aloud, Repeat Sentence, Describe Image", "single response scores multiple skill components", "faster results than IELTS or TOEFL"],
    faqs: [
  ...
  "duolingo-english-test-preparation-course-3e98dca7": {
    ...
    courseDetailHighlights: ["fully adaptive, at-home webcam test", "varied item types: word selection, written samples", "unscored video interview reviewed by institutions", "shorter and less expensive than alternatives"],
    faqs: [
  ...
  "gcse-preparation-course-97ec8c86": {
    ...
    courseDetailHighlights: ["9-1 grading scale, grade 4 pass", "Foundation vs. Higher tier trade-offs", "exam board differences: AQA, Edexcel, OCR", "mark-scheme technique: command words, method marks"],
    faqs: [
  ...
  "gcse-english-017a23a5": {
    ...
    courseDetailHighlights: ["Language: unseen extracts, creative and transactional writing", "Literature: Shakespeare, 19th-century novel, poetry anthology", "memorized quotation recall for Literature exams", "board-specific set texts: AQA vs. Edexcel"],
    faqs: [
  ...
  "igcse-preparation-course-5ed7859f": {
    ...
    courseDetailHighlights: ["Cambridge Core vs. Extended tier structure", "Edexcel vs. Cambridge: separate specifications", "terminal exams weighted over coursework", "command-word and mark-scheme conventions"],
    faqs: [
  ...
  "a-level-preparation-course-6ede4ec7": {
    ...
    courseDetailHighlights: ["linear structure: AS results don't count", "A* to E grading scale", "university offers tied to grade combinations", "content builds fast on GCSE foundations"],
    faqs: [
  ...
  "ib-diploma-preparation-course-9e537a20": {
    ...
    courseDetailHighlights: ["six subjects across six subject groups", "core requirements: TOK, Extended Essay, CAS", "scored 1-7 per subject, 45-point total", "HL vs. SL: shared syllabus, extra HL content"],
    faqs: [
  ...
  "ap-exam-preparation-course-cceffa19": {
    ...
    courseDetailHighlights: ["multiple-choice and free-response near-even split", "free-response rubrics: thesis, shown work, reasoning", "scored 1-5, college credit typically at 3+", "fixed May window, no retake until next year"],
    faqs: [
