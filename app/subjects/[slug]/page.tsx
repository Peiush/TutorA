...
import { getSubjectBySlug, getSubjects, getRelatedSubjects, type SubjectListing } from "@/app/lib/subject-listings";
...
export async function generateMetadata({
  ...
  const title = subjectMetaTitle(subject);
...
export default async function SubjectDetailPage({
  ...
  const [savedSubject, openRequest, relatedSubjects] = userId
    ? await Promise.all([
    ...
    : [null, null, await getRelatedSubjects(subject.id, subject.curriculum)];
