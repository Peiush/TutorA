# Content Brief: AP Exam

**Mode:** IMPROVE (rewrite of existing live page) — not a new page
**Hub page:** `/courses/ap-exam-preparation-course-cceffa19` (`https://www.tutora.it.com/courses/ap-exam-preparation-course-cceffa19`)
**File / slug:** `ap-exam-preparation-course-cceffa19`
...
### Search Intent
Primarily **commercial** ("AP Exam tutor", "AP Exam tutoring online", "AP Exam prep course") — someone ready to hire a 1:1 tutor or enrol in a prep course, comparing providers. Secondary **commercial-local** ("AP Exam tutor near me") and **commercial-trust** ("AP Exam score guarantee") intent. Google rewards long-form Service/Hybrid pages here, not listing cards: Real SERP for 'AP Exam tutor' / 'AP Exam tutoring online' is dominated by UK/international tutoring services that foreground tutor credentials (MyTutor -- 1-in-8 acceptance rate, TutorChase -- 'IB examiners', Keystone Tutors, GoStudent, Sherpa -- DBS-checked, exam-board coverage AQA/Edexcel/OCR/Cambridge). No thin product-listing pages rank -- confirms the prior SXO finding for AP Exam.
...
| 5 | TestPrepInsight / BestColleges | Third-party "best AP Exam tutor" rankings/comparisons | Listicle | TutorA has no comparison or ranking-style trust signal |
...
- **Quality gap:** Thin/generic copy is shared sitewide via one FAQ block; none of it is AP Exam-specific.

### Winning Outline

**H1:** AP Exam tutor — 1:1 AP Exam Tutoring on TutorA
**URL Slug:** `/courses/ap-exam-preparation-course-cceffa19` (unchanged — this is a rewrite, not a new URL)
...
1. **Intro / value prop** (~120 words) — Primary keyword "AP Exam tutor" in the first 100 words. State plainly what TutorA offers: matched, vetted 1:1 AP Exam tutors, live sessions, not a self-paced course. No fabricated stats.
2. **What AP Exam tutoring on TutorA includes** (~120 words, H2) — definition-box style. Use secondary keyword "AP Exam tutoring online" in the H2. Cover format (live, 1:1, online), typical session structure, how matching works.
3. **Credentialed tutor bios** (~250 words, H2 + repeatable bio card structure) — **NEEDS REAL INPUT.** Do not fabricate. Structure only:
   ...
   - Years tutoring AP Exam specifically
...
5. **Pricing** (~90 words, H2) — Answers "AP Exam tutoring cost" honestly: pricing varies by tutor and is shown before booking (this matches the real site FAQ in `lib/course-faqs.ts` — do not invent a flat price).
...
- **AP Exam tutoring cost** — commercial intent. Pricing FAQ.
- **AP Exam tutoring for year 10 students** — commercial intent. Audience-segment FAQ variant.
- **how much does AP Exam tutoring cost** — informational-commercial intent. Pricing FAQ.
- **AP Exam revision timetable** — informational intent. Content-gap FAQ opportunity.
   - Plus one light-touch resource mention for: “AP Exam past papers”, “AP Exam syllabus”, “what is AP Exam” — one or two sentences max, linking out to the official test body/free resource rather than trying to rank for it directly.
10. **CTA** (~40 words) — "Request a AP Exam tutor" button linking to `/request-a-tutor`, secondary link to `/find-a-tutor`.

### Recommended Meta Tags

**Title** (55 chars)
AP Exam tutor Online — Book a Vetted 1:1 Match | TutorA

**Meta Description** (133 chars)
Work 1:1 with a vetted AP Exam tutor on TutorA. Personalised live sessions, transparent pricing, real results. Request a tutor today.
...
- Real, verifiable tutor credentials (not invented) — degree/certification, years of AP Exam-specific experience
...
- From `/courses` (hub/listing page) → this page, anchor: "AP Exam tutoring"
- This page → `/request-a-tutor`, anchor: "Request a AP Exam tutor" (primary CTA)
- This page → `/find-a-tutor`, anchor: "Browse AP Exam tutors"
