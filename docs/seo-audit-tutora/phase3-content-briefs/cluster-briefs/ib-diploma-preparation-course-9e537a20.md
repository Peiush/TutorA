# Content Brief: IB Diploma

**Mode:** IMPROVE (rewrite of existing live page) — not a new page
**Hub page:** `/courses/ib-diploma-preparation-course-9e537a20` (`https://www.tutora.it.com/courses/ib-diploma-preparation-course-9e537a20`)
**File / slug:** `ib-diploma-preparation-course-9e537a20`
...
## Content Brief: IB Diploma tutor
...
### Search Intent
Primarily **commercial** ("IB Diploma tutor", "IB Diploma tutoring online", "IB Diploma prep course") — someone ready to hire a 1:1 tutor or enrol in a prep course, comparing providers. Secondary **commercial-local** ("IB Diploma tutor near me") and **commercial-trust** ("IB Diploma score guarantee") intent. Google rewards long-form Service/Hybrid pages here, not listing cards: Real SERP for 'IB Diploma tutor' / 'IB Diploma tutoring online' is dominated by UK/international tutoring services that foreground tutor credentials (MyTutor -- 1-in-8 acceptance rate, TutorChase -- 'IB examiners', Keystone Tutors, GoStudent, Sherpa -- DBS-checked, exam-board coverage AQA/Edexcel/OCR/Cambridge). No thin product-listing pages rank -- confirms the prior SXO finding for IB Diploma.
...
| 5 | TestPrepInsight / BestColleges | Third-party "best IB Diploma tutor" rankings/comparisons | Listicle | TutorA has no comparison or ranking-style trust signal |
...
- **Quality gap:** Thin/generic copy is shared sitewide via one FAQ block; none of it is IB Diploma-specific.

### Winning Outline

**H1:** IB Diploma tutor — 1:1 IB Diploma Tutoring on TutorA
**URL Slug:** `/courses/ib-diploma-preparation-course-9e537a20` (unchanged — this is a rewrite, not a new URL)
...
1. **Intro / value prop** (~120 words) — Primary keyword "IB Diploma tutor" in the first 100 words. State plainly what TutorA offers: matched, vetted 1:1 IB Diploma tutors, live sessions, not a self-paced course. No fabricated stats.
2. **What IB Diploma tutoring on TutorA includes** (~120 words, H2) — definition-box style. Use secondary keyword "IB Diploma tutoring online" in the H2. Cover format (live, 1:1, online), typical session structure, how matching works.
3. **Credentialed tutor bios** (~250 words, H2 + repeatable bio card structure) — **NEEDS REAL INPUT.** Do not fabricate. Structure only:
   ...
   - Years tutoring IB Diploma specifically
...
5. **Pricing** (~90 words, H2) — Answers "IB Diploma tutoring cost" honestly: pricing varies by tutor and is shown before booking (this matches the real site FAQ in `lib/course-faqs.ts` — do not invent a flat price).
...
- **IB Diploma tutoring cost** — commercial intent. Pricing FAQ.
- **IB Diploma tutoring for year 10 students** — commercial intent. Audience-segment FAQ variant.
- **how much does IB Diploma tutoring cost** — informational-commercial intent. Pricing FAQ.
- **IB Diploma revision timetable** — informational intent. Content-gap FAQ opportunity.
   - Plus one light-touch resource mention for: “IB Diploma past papers”, “IB Diploma syllabus”, “what is IB Diploma” — one or two sentences max, linking out to the official test body/free resource rather than trying to rank for it directly.
10. **CTA** (~40 words) — "Request a IB Diploma tutor" button linking to `/request-a-tutor`, secondary link to `/find-a-tutor`.

### Recommended Meta Tags

**Title** (52 chars)
Find a Vetted IB Diploma tutor Online Today | TutorA

**Meta Description** (136 chars)
Work 1:1 with a vetted IB Diploma tutor on TutorA. Personalised live sessions, transparent pricing, real results. Request a tutor today.
...
- Real, verifiable tutor credentials (not invented) — degree/certification, years of IB Diploma-specific experience
...
- From `/courses` (hub/listing page) → this page, anchor: "IB Diploma tutoring"
- This page → `/request-a-tutor`, anchor: "Request a IB Diploma tutor" (primary CTA)
- This page → `/find-a-tutor`, anchor: "Browse IB Diploma tutors"
