# Content Brief: Duolingo English Test

**Mode:** IMPROVE (rewrite of existing live page) — not a new page
**Hub page:** `/courses/duolingo-english-test-preparation-course-3e98dca7` (`https://www.tutora.it.com/courses/duolingo-english-test-preparation-course-3e98dca7`)
**File / slug:** `duolingo-english-test-preparation-course-3e98dca7`
...
## Content Brief: Duolingo English Test tutor
...
| 5 | TestPrepInsight / BestColleges | Third-party "best Duolingo English Test tutor" rankings/comparisons | Listicle | TutorA has no comparison or ranking-style trust signal |
...
- **Quality gap:** Thin/generic copy is shared sitewide via one FAQ block; none of it is Duolingo English Test-specific.

### Winning Outline

**H1:** Duolingo English Test tutor — 1:1 Duolingo English Test Tutoring on TutorA
**URL Slug:** `/courses/duolingo-english-test-preparation-course-3e98dca7` (unchanged — this is a rewrite, not a new URL)
...
1. **Intro / value prop** (~120 words) — Primary keyword "Duolingo English Test tutor" in the first 100 words. State plainly what TutorA offers: matched, vetted 1:1 Duolingo English Test tutors, live sessions, not a self-paced course. No fabricated stats.
2. **What Duolingo English Test tutoring on TutorA includes** (~120 words, H2) — definition-box style. Use secondary keyword "Duolingo English Test tutoring online" in the H2. Cover format (live, 1:1, online), typical session structure, how matching works.
3. **Credentialed tutor bios** (~250 words, H2 + repeatable bio card structure) — **NEEDS REAL INPUT.** Do not fabricate. Structure only:
   ...
   - Years tutoring Duolingo English Test specifically
...
5. **Pricing** (~90 words, H2) — Answers "Duolingo English Test tutoring cost" honestly: pricing varies by tutor and is shown before booking (this matches the real site FAQ in `lib/course-faqs.ts` — do not invent a flat price).
...
- **Duolingo English Test tutoring cost** — commercial intent. Adjacent commercial-informational query; answer as FAQ entry on hub page rather than new page.
- **Duolingo English Test tutoring for high schoolers** — commercial intent. Audience-segment variant; fold into hub page's audience/FAQ section.
- **how much does Duolingo English Test tutoring cost** — informational-commercial intent. Pricing FAQ; fold into hub FAQ block.
- **Duolingo English Test study plan** — informational intent. Content-gap FAQ opportunity; low commercial intent but supports hub page depth.
- **when to start Duolingo English Test prep** — informational intent. Content-gap FAQ opportunity.
   - Plus one light-touch resource mention for: “Duolingo English Test practice test”, “Duolingo English Test test dates”, “what is the Duolingo English Test” — one or two sentences max, linking out to the official test body/free resource rather than trying to rank for it directly.
10. **CTA** (~40 words) — "Request a Duolingo English Test tutor" button linking to `/request-a-tutor`, secondary link to `/find-a-tutor`.

### Recommended Meta Tags

**Title** (50 chars)
Hire a Vetted Duolingo English Test tutor | TutorA

**Meta Description** (147 chars)
Work 1:1 with a vetted Duolingo English Test tutor on TutorA. Personalised live sessions, transparent pricing, real results. Request a tutor today.
...
- Real, verifiable tutor credentials (not invented) — degree/certification, years of Duolingo English Test-specific experience
...
- From `/courses` (hub/listing page) → this page, anchor: "Duolingo English Test tutoring"
- This page → `/request-a-tutor`, anchor: "Request a Duolingo English Test tutor" (primary CTA)
- This page → `/find-a-tutor`, anchor: "Browse Duolingo English Test tutors"
