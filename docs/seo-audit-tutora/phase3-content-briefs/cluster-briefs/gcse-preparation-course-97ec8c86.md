...
**Hub page:** `/courses/gcse-preparation-course-97ec8c86` (`https://www.tutora.it.com/courses/gcse-preparation-course-97ec8c86`)
**File / slug:** `gcse-preparation-course-97ec8c86`
...
### Search Intent
Primarily **commercial** ("GCSE tutor", "GCSE tutoring online", "GCSE prep course") — someone ready to hire a 1:1 tutor or enrol in a prep course, comparing providers. Secondary **commercial-local** ("GCSE tutor near me") and **commercial-trust** ("GCSE score guarantee") intent. Google rewards long-form Service/Hybrid pages here, not listing cards: Real SERP for 'GCSE tutor' / 'GCSE tutoring online' is dominated by UK/international tutoring services that foreground tutor credentials (MyTutor -- 1-in-8 acceptance rate, TutorChase -- 'IB examiners', Keystone Tutors, GoStudent, Sherpa -- DBS-checked, exam-board coverage AQA/Edexcel/OCR/Cambridge). No thin product-listing pages rank -- confirms the prior SXO finding for GCSE.
...
| 5 | TestPrepInsight / BestColleges | Third-party "best GCSE tutor" rankings/comparisons | Listicle | TutorA has no comparison or ranking-style trust signal |
...
- **Quality gap:** Thin/generic copy is shared sitewide via one FAQ block; none of it is GCSE-specific.

### Winning Outline

**H1:** GCSE tutor — 1:1 GCSE Tutoring on TutorA
**URL Slug:** `/courses/gcse-preparation-course-97ec8c86` (unchanged — this is a rewrite, not a new URL)
...
1. **Intro / value prop** (~120 words) — Primary keyword "GCSE tutor" in the first 100 words. State plainly what TutorA offers: matched, vetted 1:1 GCSE tutors, live sessions, not a self-paced course. No fabricated stats.
2. **What GCSE tutoring on TutorA includes** (~120 words, H2) — definition-box style. Use secondary keyword "GCSE tutoring online" in the H2. Cover format (live, 1:1, online), typical session structure, how matching works.
3. **Credentialed tutor bios** (~250 words, H2 + repeatable bio card structure) — **NEEDS REAL INPUT.** Do not fabricate. Structure only:
   ...
   - Years tutoring GCSE specifically
...
5. **Pricing** (~90 words, H2) — Answers "GCSE tutoring cost" honestly: pricing varies by tutor and is shown before booking (this matches the real site FAQ in `lib/course-faqs.ts` — do not invent a flat price).
...
- **GCSE tutoring cost** — commercial intent. Pricing FAQ.
- **GCSE tutoring for year 10 students** — commercial intent. Audience-segment FAQ variant.
- **how much does GCSE tutoring cost** — informational-commercial intent. Pricing FAQ.
- **GCSE revision timetable** — informational intent. Content-gap FAQ opportunity.
   - Plus one light-touch resource mention for: “GCSE past papers”, “GCSE syllabus”, “what is GCSE” — one or two sentences max, linking out to the official test body/free resource rather than trying to rank for it directly.
- **Required cross-link:** parent-curriculum -> subject-specific spoke to **GCSE English** (anchor text: "GCSE English tutoring"). Add this link in the intro or a dedicated "Related subjects" line near the FAQ.

10. **CTA** (~40 words) — "Request a GCSE tutor" button linking to `/request-a-tutor`, secondary link to `/find-a-tutor`.

### Recommended Meta Tags

**Title** (52 chars)
GCSE tutor Online — Book a Vetted 1:1 Match | TutorA

**Meta Description** (130 chars)
Work 1:1 with a vetted GCSE tutor on TutorA. Personalised live sessions, transparent pricing, real results. Request a tutor today.
...
- Real, verifiable tutor credentials (not invented) — degree/certification, years of GCSE-specific experience
...
- From `/courses` (hub/listing page) → this page, anchor: "GCSE tutoring"
- This page → `/request-a-tutor`, anchor: "Request a GCSE tutor" (primary CTA)
- This page → `/find-a-tutor`, anchor: "Browse GCSE tutors"
- This page → `/about`, anchor: "How we vet our tutors" (supports E-E-A-T)
- This page ↔ `/courses/gcse-english-017a23a5`, anchor: "GCSE English tutoring"
